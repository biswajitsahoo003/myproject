package com.tcl.dias.billing.swagger.constants;
...
public class SwaggerConstants {
	...
	public static class ApiOperations {
		...
		public static class Billing {
			...
			public static final String FECTH_ALL_INVOICES_FOR_USER = "Get All Invoices for User";
			public static final String GET_INVOICE = "Get Invoice by ID";
			public static final String GET_MULTIPLE_INVOICES = "Get Invoices requested for IDs";

		}
		
		public static class BillingDisputes {
			
			private BillingDisputes() {
			}
			public static final String FECTH_BILLING_DISPUTE_TICKETS_FOR_USER = "Get Billing Dispute Tickets for User";
			public static final String RAISE_SINGLE_BILLING_DISPUTE_TICKET = "Raise Single Billing Dispute Ticket";
			public static final String RAISE_BULK_BILLING_DISPUTE_TICKET = "Raise Bulk Billing Dispute Ticket";
			public static final String ADD_COMMENTS_BILLING_DISPUTE_TICKET = "Add Comments Billing Dispute Ticket";
			public static final String UPDATE_COMMENTS_ATTACHMENTS_BILLING_DISPUTE_TICKET = "Update Comments Attachments for Billing Dispute Ticket";
	...
	public static class Finance {
			...
			public static final String GET_ALL_FINANCE_DETAILS = "Get all the finance details";
			public static final String GET_ALL_SOA_PDF = "Get all the open transactions in pdf";
