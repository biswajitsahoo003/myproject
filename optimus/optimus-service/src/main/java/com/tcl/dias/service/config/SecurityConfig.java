package com.tcl.dias.service.config;
...
/**
 *
 * This class have all the security configs
 * 
 *
 * @author Manojkumar R
...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
				...
				.antMatchers("/isv/**").hasAnyAuthority(UserActionsConstants.INTERNAL_ACCESS_GROUP)
				.antMatchers("/v1/**").hasAnyAuthority(ObjectArrays.concat(UserActionsConstants.CUSTOMER_ACCESS_GROUP,
				UserActionsConstants.PARTNER_ACCESS_GROUP, String.class)).and()
				.authorizeRequests();
	}
