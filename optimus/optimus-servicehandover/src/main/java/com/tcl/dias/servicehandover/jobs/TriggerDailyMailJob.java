...
import com.tcl.dias.servicefulfillment.entity.entities.NotificationMailJob;
import com.tcl.dias.servicefulfillment.entity.repository.NotificationMailJobRepository;
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		for (NotificationMailJob notificationMailJob : notificationMailJobs) {
			try {
				...
				mqUtils.send(notificationMailJob.getQueueName(), notificationMailJob.getMailRequest());
