...
import com.tcl.dias.networkaugment.entity.repository.MstTaskAttributeRepository;
...
public class TaskAttributeMasterSingleton {
	...
	public TaskAttributeMasterSingleton(MstTaskAttributeRepository mstTaskAttributeRepository) {
		...
		LOGGER.info("Network Augmentation Initilized the task Attribute Master with total tasks as {} !!!", getTaskAttributes().size());
	}
