...
public class ServiceTaskEndListener implements ExecutionListener {
	...
	private static final Logger logger = LoggerFactory.getLogger(ServiceTaskEndListener.class);
	...
	public void notify(DelegateExecution execution) {
		logger.info("ServiceTaskEndListener invoked for {} id: {} ProcessInstanceId:{}  EventName:{} ",execution.getCurrentActivityId(),
