 ...
 */
@Entity
@Table(name = "vw_ucaas_ob_all_ctry_price_book")
@NamedQuery(name = "WebexOutboundAllCountryPricing.findAll", query = "SELECT w FROM WebexOutboundAllCountryPricing w")
public class WebexOutboundAllCountryPricing implements Serializable {
	...
	public WebexOutboundAllCountryPricing() {
	}
