 ...
 */
@Entity
@Table(name = "vw_ucaas_lns_shared_pay_per_seat_price_book")
@NamedQuery(name = "WebexLnsSharedPayPerSeatPricing.findAll", query = "SELECT w FROM WebexLnsSharedPayPerSeatPricing w")
public class WebexLnsSharedPayPerSeatPricing implements Serializable {
	...
	public WebexLnsSharedPayPerSeatPricing() {
	}
