...
/**
 * The persistent class for the vw_cpe_bom_GVPN database table.
 * 
 */
@Entity
@Immutable
@Table(name="vw_cpe_bom_GVPN")
@IdClass(CpeBomGvpnViewId.class)
public class CpeBomGvpnView implements Serializable {
