...
public class CreateMuxPlannedEventBean extends BaseRequest {
    ...
    private String riskAndImpactAnalysis;
    private String shortDescription;
    private String subCategory;
    private String urgency;
    private VariableList variableList;
    private String workNotes;
    private String raisePlannedEvent;
    ...
    public String getRiskAndImpactAnalysis() {
        return riskAndImpactAnalysis;
    }

    public void setRiskAndImpactAnalysis(String riskAndImpactAnalysis) {
    ...
    public String getRaisePlannedEvent() {
        return raisePlannedEvent;
    }

    public void setRaisePlannedEvent(String raisePlannedEvent) {
        this.raisePlannedEvent = raisePlannedEvent;
    }
