...
public class ServiceDetailBean implements Serializable {
	...
	//MultiVrf attribute
	private String flexiCos;
	private String multiVrfSolution;
	private String totalVrfBandwidthMbps;
	private String numberOfVrf;
	private String vrfBasedBilling;
	private String masterVrfFlag;
	...
	private List<AluSchedulerPolicyBean> aluSchedulerPolicyBeans;

	private List<CiscoImportMapBean> ciscoImportMapBeans;

	private List<IpAddressDetailBean> ipAddressDetailBeans;

	private List<LmComponentBean> lmComponentBeans;

	private List<MulticastingBean> multicastingBeans;

	private List<ServiceQoBean> serviceQoBeans;

	private List<VpnSolutionBean> vpnSolutionBeans;

	private List<VrfBean> vrfBeans;

	private InterfaceProtocolMappingBean interfaceProtocolMappingBean;

	private List<TopologyBean> topologyBeans;



	public List<AluSchedulerPolicyBean> getAluSchedulerPolicyBeans() {
		if (aluSchedulerPolicyBeans==null) {
			aluSchedulerPolicyBeans=new ArrayList<>();
		}
		return aluSchedulerPolicyBeans;
	}

	public void setAluSchedulerPolicyBeans(List<AluSchedulerPolicyBean> aluSchedulerPolicyBeans) {
		this.aluSchedulerPolicyBeans = aluSchedulerPolicyBeans;
	}

	public List<CiscoImportMapBean> getCiscoImportMapBeans() {
		if(ciscoImportMapBeans==null){
			ciscoImportMapBeans = new ArrayList<>();
		}
		return ciscoImportMapBeans;
	}

	public void setCiscoImportMapBeans(List<CiscoImportMapBean> ciscoImportMapBeans) {
		this.ciscoImportMapBeans = ciscoImportMapBeans;
	}

	public List<IpAddressDetailBean> getIpAddressDetailBeans() {
		if(ipAddressDetailBeans==null){
			ipAddressDetailBeans = new ArrayList<>();
		}
	...
	public List<LmComponentBean> getLmComponentBeans() {
		if(lmComponentBeans==null){
			lmComponentBeans = new ArrayList<>();
		}
		return lmComponentBeans;
	}

	public void setLmComponentBeans(List<LmComponentBean> lmComponentBeans) {
		this.lmComponentBeans = lmComponentBeans;
	}

	public List<MulticastingBean> getMulticastingBeans() {
		if(multicastingBeans==null){
			multicastingBeans = new ArrayList<>();
		}
		return multicastingBeans;
	}

	public void setMulticastingBeans(List<MulticastingBean> multicastingBeans) {
		this.multicastingBeans = multicastingBeans;
	}

	public List<ServiceQoBean> getServiceQoBeans() {
		if(serviceQoBeans == null){
			serviceQoBeans = new ArrayList<>();
		}
		return serviceQoBeans;
	}

	public void setServiceQoBeans(List<ServiceQoBean> serviceQoBeans) {
		this.serviceQoBeans = serviceQoBeans;
	}

	public List<VpnSolutionBean> getVpnSolutionBeans() {
		if(vpnSolutionBeans == null){
			vpnSolutionBeans = new ArrayList<>();
		}
		return vpnSolutionBeans;
	}

	public void setVpnSolutionBeans(List<VpnSolutionBean> vpnSolutionBeans) {
		this.vpnSolutionBeans = vpnSolutionBeans;
	}

	public List<VrfBean> getVrfBeans() {
		if(vrfBeans==null){
			vrfBeans = new ArrayList<>();
		}
		return vrfBeans;
	}

	public void setVrfBeans(List<VrfBean> vrfBeans) {
		this.vrfBeans = vrfBeans;
	}

	public List<TopologyBean> getTopologyBeans() {
		
		if (topologyBeans==null) {
			topologyBeans=new ArrayList<>();
			
		}
		return topologyBeans;
	}

	public void setTopologyBeans(List<TopologyBean> topologyBeans) {
		this.topologyBeans = topologyBeans;
	}

	public InterfaceProtocolMappingBean getInterfaceProtocolMappingBean() {
		return interfaceProtocolMappingBean;
	}

	public void setInterfaceProtocolMappingBean(InterfaceProtocolMappingBean interfaceProtocolMappingBean) {
		this.interfaceProtocolMappingBean = interfaceProtocolMappingBean;
	}
	...
	public String getFlexiCos() {
		return flexiCos;
	}

	public void setFlexiCos(String flexiCos) {
		this.flexiCos = flexiCos;
	}
	...
	public String getTotalVrfBandwidthMbps() {
		return totalVrfBandwidthMbps;
	}

	public void setTotalVrfBandwidthMbps(String totalVrfBandwidthMbps) {
		this.totalVrfBandwidthMbps = totalVrfBandwidthMbps;
	}

	public String getNumberOfVrf() {
		return numberOfVrf;
	}

	public void setNumberOfVrf(String numberOfVrf) {
		this.numberOfVrf = numberOfVrf;
	}

	public String getVrfBasedBilling() {
		return vrfBasedBilling;
	}

	public void setVrfBasedBilling(String vrfBasedBilling) {
		this.vrfBasedBilling = vrfBasedBilling;
	}
	public String getMasterVrfFlag() {
		return masterVrfFlag;
	}

	public void setMasterVrfFlag(String masterVrfFlag) {
		this.masterVrfFlag = masterVrfFlag;
	}
}