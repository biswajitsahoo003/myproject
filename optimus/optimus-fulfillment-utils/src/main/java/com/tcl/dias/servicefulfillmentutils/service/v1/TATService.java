...
import com.tcl.dias.servicefulfillment.entity.entities.BusinessHourTemplate;
...
import com.tcl.dias.servicefulfillment.entity.entities.HolidayTemplate;
import com.tcl.dias.servicefulfillment.entity.repository.BusinessHourTemplateRepository;
import com.tcl.dias.servicefulfillment.entity.repository.GroupToBusinessHourTemplateRepository;
import com.tcl.dias.servicefulfillment.entity.repository.GroupToHolidayTemplateRepository;
import com.tcl.dias.servicefulfillment.entity.repository.HolidayTemplateRepository;
...
public class TATService {
    ...
    public Timestamp calculateDueDate(int tat, String groupName, Timestamp taskCreateTime) {
        ...
        try {
        	...
        	if(groupName==null || groupName.equalsIgnoreCase("SYSTEM")) {
               return Timestamp.valueOf(operatingDate.toLocalDateTime().plusMinutes(tat));
