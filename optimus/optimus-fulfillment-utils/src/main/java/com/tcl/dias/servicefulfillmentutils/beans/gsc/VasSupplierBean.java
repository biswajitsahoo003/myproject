...
public class VasSupplierBean {
	...
	private List<String> supplierEmailAddresses;
	...
	public List<String> getSupplierEmailAddresses() {
	...
	public void setSupplierEmailAddresses(List<String> supplierEmailAddresses) {
