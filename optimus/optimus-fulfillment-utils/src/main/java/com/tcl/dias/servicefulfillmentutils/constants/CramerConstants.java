...
public class CramerConstants {
	...
	public static final String REQUESTING_SYSTEM = "OPTIMUS";
    ...
    public static final String SERVICE_TOPOLOGY = "serviceTopology";
	...
	public static final String ORDERTYPETERMINATION = "TERMINATION";
