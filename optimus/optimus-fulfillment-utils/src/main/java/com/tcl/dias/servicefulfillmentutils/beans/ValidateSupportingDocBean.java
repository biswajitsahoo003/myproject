...
public class ValidateSupportingDocBean extends BaseRequest {
    ...
    private String migSfdcTermOptIdL;
	...
	public String getMigSfdcTermOptIdL() {
		return migSfdcTermOptIdL;
	}

	public void setMigSfdcTermOptIdL(String migSfdcTermOptIdL) {
		this.migSfdcTermOptIdL = migSfdcTermOptIdL;
	}
}
