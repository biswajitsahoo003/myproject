...
@Entity
@Table(name = "mst_cambium_details")
@NamedQuery(name = "MstCambiumDetails.findAll", query = "SELECT m FROM MstCambiumDetails m")
public class MstCambiumDetails implements Serializable {
