 ...
 * 
 */
@WebFault(name = "ServiceFault", targetNamespace = "http://cramerserviceslibrary/csvc/wsdl/v1/muxdetail")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: cramerserviceslibrary.csvc.wsdl.v1.muxdetail.ServiceFault
     */
