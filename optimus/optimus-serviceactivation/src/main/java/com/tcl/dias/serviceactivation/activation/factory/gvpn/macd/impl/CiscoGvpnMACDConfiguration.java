package com.tcl.dias.serviceactivation.activation.factory.gvpn.macd.impl;
...
import com.tcl.dias.serviceactivation.activation.factory.gvpn.macd.base.AbstractGvpnMACDConfiguration;
...
/**
 * This file contains the CiscoIllMACDConfiguration.java class.
 * 
 *
 * @author Dimple S
 ...
 */
@Component
public class CiscoGvpnMACDConfiguration extends AbstractGvpnMACDConfiguration {
	...
	protected EthernetInterface createEthernetInterface(
		...
		EthernetInterface ethernetInterface = super.createEthernetInterface(ethernetInterfaceEntity, router,
				wanInterface);
	...
	protected BGPRoutingProtocol createWanRoutingBgpRoutingProtocol(Bgp bgp) {
		...
		for (PolicyType policyType : policyTypes) {
			...
			if (bgp.getBgpneighbourinboundv4routermapname() != null && bgp.getIsbgpNeighbourInboundv4RoutemapEnabled()==1)
				bgpRoutingProtocol.setBGPNeighborInboundRouteMap(bgp.getBgpneighbourinboundv4routermapname());
			if (bgp.getBgpneighbourinboundv6routermapname() != null && bgp.getIsbgpNeighbourInboundv6RoutemapEnabled()==1)
