...
@XmlRootElement(name = "submitCramerIPServiceFailureResponse")
public class SubmitCramerIPServiceFailureResponse {

    @XmlElement(required = true, nillable = true)
    protected CramerServiceHeader header;
    @XmlElement(required = true, nillable = true)
    protected CramerIPServiceRequestFailure request;
     ...
     * @return
     *     possible object is
     *     {@link CramerIPServiceRequestFailure }
     *     
     */
    public CramerIPServiceRequestFailure getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(CramerIPServiceRequestFailure value) {
        this.request = value;
    }
