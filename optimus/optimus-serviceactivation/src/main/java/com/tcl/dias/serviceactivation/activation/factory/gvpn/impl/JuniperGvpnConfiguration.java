 ...
 */
@Component
public class JuniperGvpnConfiguration extends AbstractGvpnConfiguration {
					...
					for (PolicyTypeCriteriaMapping polcyTypeCriteria : policyTypeCriteria) {
						...
						if (policyCriterias != null) {
							if (policyCriterias.getTermSetcriteriaAction() != null
								...
								if (StringUtils.isNotBlank(policyCriterias.getTermSetcriteriaAction()))
									routingPolicyTerm
											.setTermAction(policyCriterias.getTermSetcriteriaAction().toUpperCase());
								if (StringUtils.isNotBlank(policyCriterias.getTermName()))
									routingPolicyTerm.setId(policyCriterias.getTermName().toUpperCase());
