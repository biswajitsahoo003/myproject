...
@Component
public class R1FeasibilityDelegate implements JavaDelegate {

	private static final Logger LOGGER = LoggerFactory.getLogger(R1FeasibilityDelegate.class);
	...
	public void execute(DelegateExecution execution) throws Exception {
		/*
		 * List<Map<String, Object>> r1Sites = (List<Map<String, Object>>)
		 * execution.getVariable("r1site"); JSONArray arr = new JSONArray();
		 * arr.addAll(r1Sites); JSONObject topObj = new JSONObject();
		 * topObj.put("input_data", arr); List<Map<String, Object>> r1Output =
		 * postURL(topObj.toString()); execution.setVariable("r1Output", r1Output);
		 */
		try {
			...
			LOGGER.info("R1 output json  :::::: {}",r1Output);

			/*
			 * for(Map<String, Object> map1 : r1Sites) { for(Map<String, Object> map2 :
			 * r1Output) { if(map1.get("Site_id").equals(map2.get("Site_id"))) {
			 * map1.putAll(map2); break; } } }
			 */
