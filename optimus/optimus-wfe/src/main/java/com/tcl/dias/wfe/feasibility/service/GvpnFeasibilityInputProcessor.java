...
/**
 * This is input processor for gvpn orchestration.
 * @author PAULRAJ SUNDAR
 *
 */
public class GvpnFeasibilityInputProcessor implements JavaDelegate {

	private static final Logger LOGGER = LoggerFactory.getLogger(GvpnFeasibilityInputProcessor.class);
