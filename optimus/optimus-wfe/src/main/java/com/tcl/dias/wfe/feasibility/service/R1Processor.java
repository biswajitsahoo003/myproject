...
import com.tcl.dias.wfe.task.R1;

public class R1Processor implements JavaDelegate {

	private static final Logger LOGGER = LoggerFactory.getLogger(R1Processor.class);
