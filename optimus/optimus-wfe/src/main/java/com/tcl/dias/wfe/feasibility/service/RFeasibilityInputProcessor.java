...
public class RFeasibilityInputProcessor implements JavaDelegate {

	private static final Logger LOGGER = LoggerFactory.getLogger(RFeasibilityInputProcessor.class);
