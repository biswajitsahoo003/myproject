...
import com.tcl.dias.wfe.task.R2;

public class R2Processor implements JavaDelegate {


	private static final Logger LOGGER = LoggerFactory.getLogger(R2Processor.class);
