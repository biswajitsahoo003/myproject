...
public class OrderIllSitesWithFeasiblityAndPricingBean implements Serializable {
	...
	private List<OrderIllSitesFeasiblityBean> feasiblityDetails;

	private List<PricingDetailBean> pricingDetails;

	public List<OrderIllSitesFeasiblityBean> getFeasiblityDetails() {
		return feasiblityDetails;
	}

	public void setFeasiblityDetails(List<OrderIllSitesFeasiblityBean> feasiblityDetails) {
