 ...
 */
public class SecurityConfigUtils extends KeycloakWebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers("/actuator/**", "/v2/api-docs", "/swagger**", "/swagger/**","/utils/**","/health/**");
	}
