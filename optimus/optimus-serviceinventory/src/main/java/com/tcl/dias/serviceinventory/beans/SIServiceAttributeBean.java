...
public class SIServiceAttributeBean {
	...
	public SIServiceAttributeBean(Integer id, Integer serviceDetailId, String attributeName, String attributeValue) {
		super();
		this.id = id;
	...
	public SIServiceAttributeBean(SIServiceAttribute entity) {
