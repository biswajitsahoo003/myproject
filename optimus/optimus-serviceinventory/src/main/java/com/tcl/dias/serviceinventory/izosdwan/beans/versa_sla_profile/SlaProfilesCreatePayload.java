...
public class SlaProfilesCreatePayload {
    @JsonProperty("sla-profile")
    private SlaProfile_ slaProfile = null;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();
    private final static long serialVersionUID = 4846833882594395300L;

    @JsonProperty("sla-profile")
    public SlaProfile_ getSlaProfile() {
        return slaProfile;
    }

    @JsonProperty("sla-profile")
    public void setSlaProfile(SlaProfile_ slaProfile) {
