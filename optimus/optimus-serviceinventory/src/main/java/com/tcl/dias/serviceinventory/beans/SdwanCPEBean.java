 ...
 */
public class SdwanCPEBean implements Serializable {
	/**
	 * 
	 */
	...
	private SdwanTemplateBean template;
	...
	public SdwanTemplateBean getTemplate() {
		return template;
	}

	public void setTemplate(SdwanTemplateBean template) {
	...
	public String toString() {
		return "SdwanCPEBean{" + "id=" + id + ", srvSysId=" + srvSysId + ", cpeName='" + cpeName + '\''
				+ ", cpeStatus='" + cpeStatus + '\'' + ", cpeAvailability='" + cpeAvailability + '\'' + ", city='"
				+ city + '\'' + ", country='" + country + '\'' + ", sdwanSiteName='" + sdwanSiteName + '\''
				+ ", sdwanSiteStatus='" + sdwanSiteStatus + '\'' + ", sdwanServiceId='" + sdwanServiceId + '\''
				+ ", underlayServiceId='" + underlayServiceId + '\'' + ", cpeUnderlaySites=" + cpeUnderlaySites
				+ ", underlaysOnlineCount=" + underlaysOnlineCount + ", underlaysOfflineCount=" + underlaysOfflineCount
				+ ", linkUpCount=" + linkUpCount + ", linkDownCount=" + linkDownCount + ", template=" + template
				+ ", alias='" + alias + '\'' + ", siteAddress='" + siteAddress + '\'' + ", model='" + model + '\''
				+ ", osVersion='" + osVersion + '\'' + ", description='" + description + '\'' + ", serialNumber='"
				+ serialNumber + '\'' + ", underlaySysId=" + underlaySysId + ", controllers=" + controllers
