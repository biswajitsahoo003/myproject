 ...
 */
public class NPLSISolutionDataOffering {
    ...
    private NPLSolutionAttributes attributes;
	 ...
	 */
	public NPLSolutionAttributes getAttributes() {
		return attributes;
	}
	 ...
	 */
	public void setAttributes(NPLSolutionAttributes attributes) {
