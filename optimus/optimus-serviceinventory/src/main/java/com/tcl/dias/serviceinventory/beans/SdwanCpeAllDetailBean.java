 ...
 */
public class SdwanCpeAllDetailBean implements Serializable {
	...
	public String toString() {
		return "SdwanCpeAllDetailBean [id=" + id + ", cpeName=" + cpeName + ", cpeAvailability=" + cpeAvailability
				...
				+ ", serialNumber=" + serialNumber + ", osVersion=" + osVersion + ", template=" + template
				+ ", underlayServiceId=" + underlayServiceId + ", sdwanServiceId=" + sdwanServiceId + ", underlaySysId="
				+ underlaySysId + ", cpeAlias=" + cpeAlias + ", controllers=" + controllers + ", timestamp=" + timestamp
				+ ", manufacturer=" + manufacturer + ", lastUpdateDate=" + lastUpdateDate + "]";
	}
