...
public class Match implements Serializable
{
    ...
    private QosPolicyApplication application;
    ...
    private final static long serialVersionUID = -1572984474198923471L;
    ...
    @JsonProperty("application")
    public QosPolicyApplication getApplication() {
        return application;
    }

    @JsonProperty("application")
    public void setApplication(QosPolicyApplication application) {
