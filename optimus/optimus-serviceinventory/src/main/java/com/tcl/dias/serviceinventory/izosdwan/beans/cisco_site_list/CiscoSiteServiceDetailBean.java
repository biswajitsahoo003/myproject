 ...
 *
 */
public class CiscoSiteServiceDetailBean implements Serializable {
	...
	private Set<CiscoSiteListBean> ciscoSiteList;
	...
	public CiscoSiteServiceDetailBean() {
	...
	public Set<CiscoSiteListBean> getCiscoSiteList() {
		return ciscoSiteList;
	}

	public void setCiscoSiteList(Set<CiscoSiteListBean> ciscoSiteList) {
