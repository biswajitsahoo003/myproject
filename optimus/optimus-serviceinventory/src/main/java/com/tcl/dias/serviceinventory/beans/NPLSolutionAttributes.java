...
/**
 * This file contains service level attributes for NPL service only.
 * 
 *
 * @author Deepika S
 ...
 */
public class NPLSolutionAttributes {
    ...
    private String connectorTypeAend;
    private String connectorTypeBend;
	...
	public String getConnectorTypeAend() {
		return connectorTypeAend;
	}

	public void setConnectorTypeAend(String connectorTypeAend) {
		this.connectorTypeAend = connectorTypeAend;
	}

	public String getConnectorTypeBend() {
		return connectorTypeBend;
	}

	public void setConnectorTypeBend(String connectorTypeBend) {
		this.connectorTypeBend = connectorTypeBend;
	}
