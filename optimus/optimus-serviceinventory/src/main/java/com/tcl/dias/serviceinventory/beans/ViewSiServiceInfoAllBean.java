...
/**
 * ViewSiServiceInfoAll Bean class
 * @author archchan
 *
 */
public class ViewSiServiceInfoAllBean implements Serializable{
	...
	public ViewSiServiceInfoAllBean() {
		
	}
	
	public ViewSiServiceInfoAllBean(ViewSiServiceInfoAll vwSiSerInfoAll){
		if(vwSiSerInfoAll != null) {
			this.accessType = vwSiSerInfoAll.getAccessType();
			this.accountManager = vwSiSerInfoAll.getAccountManager();
			this.accountManagerEmail = vwSiSerInfoAll.getAccountManager();
			this.additionalIpsReq = vwSiSerInfoAll.getAdditionalIpsReq();
			this.arc = vwSiSerInfoAll.getArc();
			this.bandwidth = vwSiSerInfoAll.getBandwidth();
			this.bandwidthDisplayName = vwSiSerInfoAll.getBandwidthDisplayName();
			this.bandwidthUnit = vwSiSerInfoAll.getBandwidthUnit();
			this.billingAddress = vwSiSerInfoAll.getBillingAddress();
			this.billingFrequency = vwSiSerInfoAll.getBillingFrequency();
			this.billingMethod = vwSiSerInfoAll.getBillingMethod();
			this.burstableBandwidth = vwSiSerInfoAll.getBurstableBandwidth();
			this.burstableBandwidthDisplayName = vwSiSerInfoAll.getBurstableBandwidthDisplayName();
			this.burstableBandwidthUnit = vwSiSerInfoAll.getBurstableBandwidthUnit();
			this.commissionedDate = vwSiSerInfoAll.getCommissionedDate();
			this.committedSla = vwSiSerInfoAll.getCommittedSla();
			this.contractStartDate = vwSiSerInfoAll.getContractStartDate();
			this.contractEndDate =vwSiSerInfoAll.getContractEndDate();
			this.currencyId = vwSiSerInfoAll.getCurrencyId();
			this.customerContact = vwSiSerInfoAll.getCustomerContact();
			this.customerContactEmail = vwSiSerInfoAll.getCustomerContactEmail();
			this.customerSiteAddress = vwSiSerInfoAll.getCustomerSiteAddress();
			this.demarcationApartment = vwSiSerInfoAll.getDemarcationApartment();
			this.demarcationFloor = vwSiSerInfoAll.getDemarcationFloor();
			//this.demarcationRack = vwSiSerInfoAll.getDemarcationRack();
			this.demarcationRoom = vwSiSerInfoAll.getDemarcationRoom();
			this.destinationCity = vwSiSerInfoAll.getDestinationCity();
			this.destinationCountry = vwSiSerInfoAll.getDestinationCountry();
			//this.erfCustPartnerLeId = vwSiSerInfoAll.getErfCustPartnerLeId();
			this.gvpnCos = vwSiSerInfoAll.getGvpnCos();
			this.gvpnSiteTopology = vwSiSerInfoAll.getGvpnSiteTopology();
			this.ipAddressArrangement = vwSiSerInfoAll.getIpAddressArrangement();
			this.ipv4AddressPoolSize = vwSiSerInfoAll.getIpv4AddressPoolSize();
			this.ipv6AddressPoolSize = vwSiSerInfoAll.getIpv6AddressPoolSize();
			this.isActive = vwSiSerInfoAll.getIsActive();
			this.izoSdwanSrvcId = vwSiSerInfoAll.getIzoSdwanSrvcId();
			this.lastMileBandwidth = vwSiSerInfoAll.getLastMileBandwidth();
			this.lastMileBandwidthUnit = vwSiSerInfoAll.getLastMileBandwidthUnit();
			this.lastMileProvider = vwSiSerInfoAll.getLastMileProvider();
			this.lastMileType = vwSiSerInfoAll.getLastMileType();
			this.latLong = vwSiSerInfoAll.getLatLong();
			//this.opportunityId = vwSiSerInfoAll.getOpportunityId();
			this.opportunityType = vwSiSerInfoAll.getOpportunityType();
			this.orderBundleOrderFlag = vwSiSerInfoAll.getOrderBundleOrderFlag();
			this.orderCode = vwSiSerInfoAll.getOrderCode();
			this.orderCreatedBy = vwSiSerInfoAll.getOrderCreatedBy();
			this.orderCustLeId = vwSiSerInfoAll.getOrderCustLeId();
			this.orderCustomerId= vwSiSerInfoAll.getOrderCustomerId();
			this.orderIsActive = vwSiSerInfoAll.getOrderIsActive();
			this.orderMultipleLeFlag = vwSiSerInfoAll.getOrderMultipleLeFlag();
			this.orderPartner = vwSiSerInfoAll.getOrderPartner();
			this.orderSysId = vwSiSerInfoAll.getOrderSysId();
			this.orderTermInMonths = vwSiSerInfoAll.getOrderTermInMonths();
			this.primaryOrSecondary = vwSiSerInfoAll.getPrimaryOrSecondary();
			this.primarySecondaryLink = vwSiSerInfoAll.getPrimarySecondaryLink();
			this.primaryServiceId = vwSiSerInfoAll.getPrimaryServiceId();
			this.productFamilyId = vwSiSerInfoAll.getProductFamilyId();
			this.productFamilyName = vwSiSerInfoAll.getProductFamilyName();
			this.productOfferingId = vwSiSerInfoAll.getProductOfferingId();
			this.serviceClassification = vwSiSerInfoAll.getServiceClassification();
			this.serviceId = vwSiSerInfoAll.getServiceId();
			this.serviceManagementOption = vwSiSerInfoAll.getServiceManagementOption();
			this.serviceRecordSequence = vwSiSerInfoAll.getServiceRecordSequence();
			this.serviceStatus = vwSiSerInfoAll.getServiceStatus();
			this.serviceType = vwSiSerInfoAll.getServiceType();
			this.siteAlias = vwSiSerInfoAll.getSiteAlias();
			this.siteEndInterface = vwSiSerInfoAll.getSiteEndInterface();
			this.siteType = vwSiSerInfoAll.getSiteType();
			this.sourceCity = vwSiSerInfoAll.getSourceCity();
			this.sourceCountry = vwSiSerInfoAll.getSourceCountry();
			this.sysId = vwSiSerInfoAll.getId();
			this.terminationDate = vwSiSerInfoAll.getTerminationDate();
			this.vpnName = vwSiSerInfoAll.getVpnName();
			this.vpnTopology = vwSiSerInfoAll.getVpnTopology();
			this.customerSiteAddress = vwSiSerInfoAll.getCustomerSiteAddress();
		}
	}
