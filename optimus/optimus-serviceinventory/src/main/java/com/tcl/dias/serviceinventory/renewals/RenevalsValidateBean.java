...
public class RenevalsValidateBean {
	...
	public String toString() {
		return "RenevalsValidateBean [serviceId=" + serviceId + ", leId=" + leId + ", custId=" + custId + ", product="
				+ product + ", offeringName=" + offeringName + ", circuitStatus=" + circuitStatus + ", serviceStatus="
				+ serviceStatus + ", isActive=" + isActive + ", remarks=" + remarks + ", locationId=" + locationId
				+ ", validLeId=" + validLeId + ", validCustId=" + validCustId + ", validProduct=" + validProduct
				+ ", crossConnectValid=" + crossConnectValid + ", validCircuit=" + validCircuit + ", validisActive="
				+ validisActive + ", validLocationId=" + validLocationId + "]";
	}
