...
/**
 * 
 * This file contains the OrderInfoBean.java class.
 * 
 *
 * @author Manojkumar R
...
public class OrderInfoBean   implements Serializable{
	...
	private Double orderTermsInMonth;
	...
	public Double getOrderTermsInMonth() {
		return orderTermsInMonth;
	}

	public void setOrderTermsInMonth(Double orderTermsInMonth) {
	...
	public String toString() {
		return "OrderInfoBean [optimusOrderCode=" + optimusOrderCode + ", scOrderId=" + scOrderId + ", parentId="
				...
				+ ", contractEndDate=" + contractEndDate + ", lastMacdDate=" + lastMacdDate + ", orderCreatedBy=" + orderCreatedBy +",orderAttributes="
				+ orderAttributes + "]";
	}
