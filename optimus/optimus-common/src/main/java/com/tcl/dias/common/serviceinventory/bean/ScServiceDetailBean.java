...
public class ScServiceDetailBean implements Serializable {
	...
	private List<ScComponentBean> scComponentBeans = new ArrayList<>();
	...
	public OptimusRfDataBean getOptimusRfDataBean() {
		return optimusRfDataBean;
	}

	public void setOptimusRfDataBean(OptimusRfDataBean optimusRfDataBean) {
		this.optimusRfDataBean = optimusRfDataBean;
	}
	...
	public List<ScComponentBean> getScComponentBeans() {
		return scComponentBeans;
	}

	public void setScComponentBeans(List<ScComponentBean> scComponentBeans) {
		this.scComponentBeans = scComponentBeans;
	}
