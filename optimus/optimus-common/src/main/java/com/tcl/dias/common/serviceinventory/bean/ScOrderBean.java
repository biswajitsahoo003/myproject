...
public class ScOrderBean {
	...
	private List<CpeBean> cpeBeans;
	private List<RouterDetailBean> routerDetailBeans;
	private List<UniswitchDetailBean> uniswitchDetailBeans;
	private VrfBean vrfBean;
	private EthernetInterfaceBean ethernetInterfaceBean;
	private ServiceQoBean serviceQoBean;
	private ServiceDetailBean serviceDetailBean;
	private IpAddressDetailBean ipAddressDetailBean;

	private MuxDetailsBean muxDetails;

	public MuxDetailsBean getMuxDetails() {
		return muxDetails;
	}

	public void setMuxDetails(MuxDetailsBean muxDetails) {
	...
	public List<CpeBean> getCpeBeans() {
		if (cpeBeans == null) {
			cpeBeans = new ArrayList<>();
		}
		return cpeBeans;
	}

	public void setCpeBeans(List<CpeBean> cpeBeans) {
		this.cpeBeans = cpeBeans;
	}

	public List<RouterDetailBean> getRouterDetailBeans() {
		if (routerDetailBeans == null) {
			routerDetailBeans = new ArrayList<>();
		}
	...
	public List<UniswitchDetailBean> getUniswitchDetailBeans() {
		if (uniswitchDetailBeans == null) {
			uniswitchDetailBeans = new ArrayList<>();
		}
		return uniswitchDetailBeans;
	}

	public void setUniswitchDetailBeans(List<UniswitchDetailBean> uniswitchDetailBeans) {
		this.uniswitchDetailBeans = uniswitchDetailBeans;
	}
	...
	public EthernetInterfaceBean getEthernetInterfaceBean() {
		return ethernetInterfaceBean;
	}

	public void setEthernetInterfaceBean(EthernetInterfaceBean ethernetInterfaceBean) {
		this.ethernetInterfaceBean = ethernetInterfaceBean;
	}

	public ServiceQoBean getServiceQoBean() {
		return serviceQoBean;
	}

	public void setServiceQoBean(ServiceQoBean serviceQoBean) {
		this.serviceQoBean = serviceQoBean;
	}
	...
	public IpAddressDetailBean getIpAddressDetailBean() {
		return ipAddressDetailBean;
	}

	public void setIpAddressDetailBean(IpAddressDetailBean ipAddressDetailBean) {
		this.ipAddressDetailBean = ipAddressDetailBean;
	}
