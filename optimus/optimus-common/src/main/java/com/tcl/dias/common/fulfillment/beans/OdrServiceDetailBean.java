...
/**
 * 
 * This file contains the OdrServiceDetailBean.java class.
 * 
 *
 * @author Manojkumar R
 ...
 */
public class OdrServiceDetailBean implements Serializable {
	...
	private Set<OdrServiceAttributeBean> odrServiceAttributes = new HashSet<>();
	private OdrOrderBean odrOrder;
	private OdrContractInfoBean odrContractInfo;
	private Set<OdrServiceSlaBean> odrServiceSlas;
	private List<OdrAttachmentBean> odrAttachments;
	private List<OdrProductDetail> odrProductDetail;
	private OdrGstAddressBean odrGstAddress;
	...
	private List<OdrAssetBean> odrAssetBeans;
	private Set<OdrComponentBean> odrComponentBeans;
	private String cancellationOrderCode;
	private Double cancellationCharges;
	private String absorbedOrPassedOn;
	
	public List<OdrAssetBean> getOdrAssetBeans() {
		return odrAssetBeans;
	}

	public void setOdrAssetBeans(List<OdrAssetBean> odrAssetBeans) {
		this.odrAssetBeans = odrAssetBeans;
	}
	private String intlDestinationCntryCode;

	public String getIntlDestinationCntryCode() {
		return intlDestinationCntryCode;
	}

	public void setIntlDestinationCntryCode(String intlDestinationCntryCode) {
		this.intlDestinationCntryCode = intlDestinationCntryCode;
	}
	...
	public void setIsPmp(String isPmp) {
		this.isPmp = isPmp;
	}
	...
	/**
	 * @return the negotiationRequired
	 */
	...
	/**
	 * @param negotiationRequired the negotiationRequired to set
	 */
	...
	/**
	 * @param etcValue the etcValue to set
	 */
	...
	/**
	 * @param etcWaiver the etcWaiver to set
	 */
	...
	/**
	 * @return the customerRequestorDate
	 */
	...
	/**
	 * @param customerRequestorDate the customerRequestorDate to set
	 */
	...
	/**
	 * @return the approvalMailAvailable
	 */
	...
	/**
	 * @param approvalMailAvailable the approvalMailAvailable to set
	 */
	...
	/**
	 * @return the backdatedTermination
	 */
	...
	/**
	 * @param backdatedTermination the backdatedTermination to set
	 */
	...
	/**
	 * @param csmEmail the csmEmail to set
	 */
	...
	/**
	 * @param csmUserName the csmUserName to set
	 */
	...
	/**
	 * @return the offnetBackhual
	 */
	public String getOffnetBackhaul() {
		return offnetBackhaul;
	}

	/**
	 * @param offnetBackhual the offnetBackhual to set
	 */
	public void setOffnetBackhaul(String offnetBackhaul) {
		this.offnetBackhaul = offnetBackhaul;
	}
	...
	public Set<OdrServiceAttributeBean> getOdrServiceAttributes() {
		return this.odrServiceAttributes;
	}

	public void setOdrServiceAttributes(Set<OdrServiceAttributeBean> odrServiceAttributes) {
		this.odrServiceAttributes = odrServiceAttributes;
	}

	public OdrServiceAttributeBean addOdrServiceAttribute(OdrServiceAttributeBean odrServiceAttribute) {
		getOdrServiceAttributes().add(odrServiceAttribute);
		odrServiceAttribute.setOdrServiceDetail(this);

		return odrServiceAttribute;
	}

	public OdrServiceAttributeBean removeOdrServiceAttribute(OdrServiceAttributeBean odrServiceAttribute) {
	...
	public OdrOrderBean getOdrOrder() {
		return this.odrOrder;
	}

	public void setOdrOrder(OdrOrderBean odrOrder) {
		this.odrOrder = odrOrder;
	}

	public OdrContractInfoBean getOdrContractInfo() {
		return this.odrContractInfo;
	}

	public void setOdrContractInfo(OdrContractInfoBean odrContractInfo) {
		this.odrContractInfo = odrContractInfo;
	}

	public Set<OdrServiceSlaBean> getOdrServiceSlas() {
		return this.odrServiceSlas;
	}

	public void setOdrServiceSlas(Set<OdrServiceSlaBean> odrServiceSlas) {
		this.odrServiceSlas = odrServiceSlas;
	}

	public List<OdrAttachmentBean> getOdrAttachments() {
		return odrAttachments;
	}

	public void setOdrAttachments(List<OdrAttachmentBean> odrAttachments) {
	...
	public OdrServiceSlaBean addOdrServiceSla(OdrServiceSlaBean odrServiceSla) {
	...
	public OdrServiceSlaBean removeOdrServiceSla(OdrServiceSlaBean odrServiceSla) {
	...
	public List<OdrProductDetail> getOdrProductDetail() {
		return odrProductDetail;
	}

	public void setOdrProductDetail(List<OdrProductDetail> odrProductDetail) {
		this.odrProductDetail = odrProductDetail;
	}

	public OdrGstAddressBean getOdrGstAddress() {
		return odrGstAddress;
	}

	public void setOdrGstAddress(OdrGstAddressBean odrGstAddress) {
		this.odrGstAddress = odrGstAddress;
	}

	public Set<OdrComponentBean> getOdrComponentBeans() {
		return odrComponentBeans;
	}

	public void setOdrComponentBeans(Set<OdrComponentBean> odrComponentBeans) {
		this.odrComponentBeans = odrComponentBeans;
	}
