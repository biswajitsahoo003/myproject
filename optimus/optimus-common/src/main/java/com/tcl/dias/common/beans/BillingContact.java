...
/**
 * This file contains the BillingContact.java class.
 * 
 *
 * @author Manojkumar R
...
public class BillingContact {
	...
	public String toString() {
		return "BillingContact [billingInfoid=" + billingInfoid + ", addressSeq=" + addressSeq + ", billAccNo="
