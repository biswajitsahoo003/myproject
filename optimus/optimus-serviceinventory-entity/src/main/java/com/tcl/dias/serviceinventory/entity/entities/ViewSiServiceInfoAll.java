...
/**
 * This file contains the SIServiceInfoAll.java class.
 * 
 *
 * @author AnneF
...
public class ViewSiServiceInfoAll implements Serializable {
	...
	/*
	 * @Column(name = "demarcation_rack") private String demarcationRack;
	 */
	...
	public void setCommittedSla(String committedSla) {
	 ...
	 public String getPartnerCuid() { return partnerCuid; }

	 public void setPartnerCuid(String partnerCuid) { this.partnerCuid =
	 partnerCuid; }

	 public String getErfCustPartnerLeId() { return erfCustPartnerLeId; }
	...
	/*
	 * public String getDemarcationRack() { return demarcationRack; }
	 * 
	 * public void setDemarcationRack(String demarcationRack) { this.demarcationRack
	 * = demarcationRack; }
	 */
