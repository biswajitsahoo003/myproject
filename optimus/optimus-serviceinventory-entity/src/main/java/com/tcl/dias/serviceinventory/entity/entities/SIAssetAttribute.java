 ...
 * The persistent class for the si_asset_attributes database table.
 * 
 */
@Entity
@Table(name="si_asset_attributes")
public class SIAssetAttribute implements Serializable {
