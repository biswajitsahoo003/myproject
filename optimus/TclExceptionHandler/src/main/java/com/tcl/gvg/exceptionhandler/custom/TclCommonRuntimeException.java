...
import com.tcl.gvg.exceptionhandler.base.BaseRuntimeException;
 ...
 * @since JDK1.0
 */
public class TclCommonRuntimeException extends BaseRuntimeException {
	...
	// For Business
	public TclCommonRuntimeException(String messageCode) {
		super(new ExceptionHandler(messageCode, null));
	}

	// For Checked and Unchecked
	public TclCommonRuntimeException(String messageCode, Throwable cause) {
		super(new ExceptionHandler(messageCode, cause));
	}

	// For Checked and Unchecked
	public TclCommonRuntimeException(Throwable cause) {
		super(new ExceptionHandler(null, cause));
	}

	// For Business
	public TclCommonRuntimeException(String messageCode, int statusCode) {
		super(new ExceptionHandler(messageCode, null));
		this.statusCode = statusCode != 0 ? statusCode : this.statusCode;
	}

	// For Checked and Unchecked
	public TclCommonRuntimeException(Throwable cause, int statusCode) {
		super(new ExceptionHandler(null, cause));
		this.statusCode = statusCode != 0 ? statusCode : this.statusCode;
	}

	// For Checked and Unchecked
	public TclCommonRuntimeException(String messageCode, Throwable cause, int statusCode) {
		super(new ExceptionHandler(messageCode, cause));
		this.statusCode = statusCode != 0 ? statusCode : this.statusCode;
	}
