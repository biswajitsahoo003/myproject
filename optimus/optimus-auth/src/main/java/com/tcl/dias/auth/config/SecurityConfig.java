package com.tcl.dias.auth.config;
...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
	...
	/**
	 * This method is used to ignore the urls which are exempted from sso
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers("/actuator/**", "/v2/api-docs", "/swagger**", "/swagger/**", "/password/**","/reset.html","/app/**","/lib/**","/images/**","/health/**");
	}
