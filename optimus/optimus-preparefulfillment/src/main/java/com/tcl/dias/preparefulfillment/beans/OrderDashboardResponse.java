...
public class OrderDashboardResponse {
	...
	private  String differentialMrc;
	private  String differentialNrc;
	...
	public String getDifferentialMrc() {
		return differentialMrc;
	}

	public void setDifferentialMrc(String differentialMrc) {
		this.differentialMrc = differentialMrc;
	}

	public String getDifferentialNrc() {
		return differentialNrc;
	}

	public void setDifferentialNrc(String differentialNrc) {
