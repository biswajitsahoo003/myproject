package com.tcl.dias.location.config;
...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
				...
				.antMatchers("/v1/cof/**").hasAnyAuthority(ObjectArrays.concat(ObjectArrays.concat(UserActionsConstants.CUSTOMER_ACCESS_GROUP,
						UserActionsConstants.PARTNER_ACCESS_GROUP, String.class),UserActionsConstants.COMMERCIAL_ACCESS_GROUP, String.class))
				.antMatchers("/isv/**").hasAnyAuthority(ObjectArrays.concat(UserActionsConstants.INTERNAL_ACCESS_GROUP,UserActionsConstants.MANUAL_FEASIBILTIY_GROUP,String.class))
				.antMatchers("/v1/**").hasAnyAuthority(ObjectArrays.concat(ObjectArrays.concat(UserActionsConstants.CUSTOMER_ACCESS_GROUP,
				UserActionsConstants.PARTNER_ACCESS_GROUP, String.class),UserActionsConstants.COMMERCIAL_ACCESS_GROUP, String.class)).and()
				.authorizeRequests();
	}
