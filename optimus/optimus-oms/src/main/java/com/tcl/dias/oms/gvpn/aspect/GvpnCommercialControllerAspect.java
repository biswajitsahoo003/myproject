package com.tcl.dias.oms.gvpn.aspect;
...
/**
 * 
 * This file contains the CommercialControllerAspect.java class.
 * 
 *
...
@Component
@Order(1)
public class GvpnCommercialControllerAspect {

	private static final Logger LOGGER = LoggerFactory.getLogger(GvpnCommercialControllerAspect.class);
	...
	@Pointcut("execution(* com.tcl.dias.oms.gvpn.controller.v1.GvpnOrderController.*(..))")
	protected void allGvpnOrderMethod() {
		// Point cut definition
	}

	@Pointcut("execution(* com.tcl.dias.oms.gvpn.controller.v1.GvpnQuoteController.*(..))")
	protected void allGvpnQuoteMethod() {
		// Point cut definition
	}
	
	@Pointcut("execution(* com.tcl.dias.oms.gvpn.dashboard.controller.v1.GvpnDashboardController.*(..))")
	protected void allGvpnDashboardMethod() {
		// Point cut definition
	}
	...
	@Around("controller() && allGvpnDashboardMethod()")
	...
	@Around("controller() && allGvpnOrderMethod()")
	...
	@Around("controller() && allGvpnQuoteMethod()")
