...
@JsonPropertyOrder({
	...
	"lat_long","old_Port_Bw","old_Ll_Bw","backup_port_requested","service_id","parallel_run_days","cpe_chassis_changed",
	"local_loop_bw",
...
public class Feasible {
	...
	private Integer lmNrcOspcapexOnwl;
	...
	@JsonProperty("cpe_chassis_changed")
	public void setCpeChasisChanged(String cpeChasisChanged) {
	...
	@JsonProperty("lm_nrc_ospcapex_onwl")
	public Integer getLmNrcOspcapexOnwl() {
		return lmNrcOspcapexOnwl;
	}

	@JsonProperty("lm_nrc_ospcapex_onwl")
	public void setLmNrcOspcapexOnwl(Integer lmNrcOspcapexOnwl) {
	...
	/**
	 * @return the backupPortRequested
	 */
	...
	/**
	 * @param backupPortRequested the backupPortRequested to set
	 */
	...
	public String toString() {
		return "Feasible{" +
				...
				", hhName='" + hhName + '\'' +
				", totalCost='" + totalCost + '\'' +
				", x05kmAvgDist=" + x05kmAvgDist +
				", pOPDISTKM=" + pOPDISTKM +
				", x05kmProspectAvgBw=" + x05kmProspectAvgBw +
				", onnetCityTag=" + onnetCityTag +
				", lmArcBwProvOfrf=" + lmArcBwProvOfrf +
				", networkFNFCC='" + networkFNFCC + '\'' +
				", lmNrcNerentalOnwl=" + lmNrcNerentalOnwl +
				", lmNrcInbldgOnwl=" + lmNrcInbldgOnwl +
				", networkFeasibilityCheck='" + networkFeasibilityCheck + '\'' +
				", coreCheckCC='" + coreCheckCC + '\'' +
				", x5kmMinBw=" + x5kmMinBw +
				", accessCheckCC='" + accessCheckCC + '\'' +
				", rank=" + rank +
				...
				", fATGBuildingType='" + fATGBuildingType + '\'' +
				", hH05AccessRingsF='" + hH05AccessRingsF + '\'' +
				", hhFlag='" + hhFlag + '\'' +
				", localLoopInterface='" + localLoopInterface + '\'' +
				", x5kmProspectAvgDist=" + x5kmProspectAvgDist +
				", latitudeFinal=" + latitudeFinal +
				", fATGNetworkLocationType='" + fATGNetworkLocationType + '\'' +
				", topology='" + topology + '\'' +
				", cityTier='" + cityTier + '\'' +
				", lmNrcBwOnwl=" + lmNrcBwOnwl +
				", x2kmProspectMinDist=" + x2kmProspectMinDist +
				", x2kmProspectPercFeasible=" + x2kmProspectPercFeasible +
				", x05kmProspectNumFeasible=" + x05kmProspectNumFeasible +
				...
				", errorFlag=" + errorFlag +
				", respCity='" + respCity + '\'' +
				", connectedCustTag=" + connectedCustTag +
				", netPreFeasibleFlag=" + netPreFeasibleFlag +
				", networkFNFCCFlag='" + networkFNFCCFlag + '\'' +
				", popLong=" + popLong +
				", orchLMType='" + orchLMType + '\'' +
				", ipv4AddressPoolSize='" + ipv4AddressPoolSize + '\'' +
				", x5kmProspectAvgBw=" + x5kmProspectAvgBw +
				", fATGCategory='" + fATGCategory + '\'' +
				", lmNrcMastOfrf=" + lmNrcMastOfrf +
				", x2kmProspectMinBw=" + x2kmProspectMinBw +
				", x5kmProspectNumFeasible=" + x5kmProspectNumFeasible +
				", selected=" + selected +
				", popName='" + popName + '\'' +
				", lmNrcMastOnrf=" + lmNrcMastOnrf +
				", x5kmProspectCount=" + x5kmProspectCount +
				", errorMsg='" + errorMsg + '\'' +
				", connectionType='" + connectionType + '\'' +
				", ipAddressArrangement='" + ipAddressArrangement + '\'' +
				", x05kmAvgBw=" + x05kmAvgBw +
				", x2kmCustCount=" + x2kmCustCount +
				", customerSegment='" + customerSegment + '\'' +
				", fATGPROW='" + fATGPROW + '\'' +
				", timeTaken=" + timeTaken +
				", connectedBuildingTag=" + connectedBuildingTag +
				", fATGDISTKM=" + fATGDISTKM +
				", x05kmProspectMaxBw=" + x05kmProspectMaxBw +
				", x5kmProspectMinDist=" + x5kmProspectMinDist +
				", type='" + type + '\'' +
				", fATGRingType='" + fATGRingType + '\'' +
				", longitudeFinal=" + longitudeFinal +
				", orchBW=" + orchBW +
				", scenario1=" + scenario1 +
				", scenario2=" + scenario2 +
				", accessCheckHh='" + accessCheckHh + '\'' +
				", x2kmProspectCount=" + x2kmProspectCount +
				", ipv6AddressPoolSize='" + ipv6AddressPoolSize + '\'' +
				", minHhFatg=" + minHhFatg +
				", pOPConstructionStatus='" + pOPConstructionStatus + '\'' +
				", x5kmAvgDist=" + x5kmAvgDist +
				", x2kmAvgDist=" + x2kmAvgDist +
				", x2kmProspectAvgBw=" + x2kmProspectAvgBw +
				", x05kmProspectMinDist=" + x05kmProspectMinDist +
				", costPermeter=" + costPermeter +
				", prospectName='" + prospectName + '\'' +
				", predictedAccessFeasibility='" + predictedAccessFeasibility + '\'' +
				", x2kmMaxBw=" + x2kmMaxBw +
				", x2kmProspectMaxBw=" + x2kmProspectMaxBw +
				", lastMileContractTerm='" + lastMileContractTerm + '\'' +
				", x5kmProspectMinBw=" + x5kmProspectMinBw +
				", x2kmMinBw=" + x2kmMinBw +
				", burstableBw=" + burstableBw +
				", popNetworkLocId='" + popNetworkLocId + '\'' +
				", bwMbps=" + bwMbps +
				", x05kmCustCount=" + x05kmCustCount +
				", x05kmMinBw=" + x05kmMinBw +
				", productName='" + productName + '\'' +
				", networkFNFHH='" + networkFNFHH + '\'' +
				", hH05AccessRingsNF='" + hH05AccessRingsNF + '\'' +
				", x05kmMinDist=" + x05kmMinDist +
				", pOPBuildingType='" + pOPBuildingType + '\'' +
				", coreCheckHh='" + coreCheckHh + '\'' +
				", hHDISTKM=" + hHDISTKM +
				", x05kmProspectMinBw=" + x05kmProspectMinBw +
				", errorCode='" + errorCode + '\'' +
				", pOPDISTKMSERVICE=" + pOPDISTKMSERVICE +
				", lmArcBwOnwl=" + lmArcBwOnwl +
				", numConnectedBuilding=" + numConnectedBuilding +
				", accountIdWith18Digit='" + accountIdWith18Digit + '\'' +
				", orchCategory='" + orchCategory + '\'' +
				", x05kmProspectAvgDist=" + x05kmProspectAvgDist +
				", pOPNetworkLocationType='" + pOPNetworkLocationType + '\'' +
				", lmNrcMuxOnwl=" + lmNrcMuxOnwl +
				", numConnectedCust=" + numConnectedCust +
				", hH05km='" + hH05km + '\'' +
				", popLat=" + popLat +
				", x5kmMinDist=" + x5kmMinDist +
				", feasibilityResponseCreatedDate='" + feasibilityResponseCreatedDate + '\'' +
				", x2kmProspectNumFeasible=" + x2kmProspectNumFeasible +
				", x2kmAvgBw=" + x2kmAvgBw +
				", x05kmMaxBw=" + x05kmMaxBw +
				", x5kmAvgBw=" + x5kmAvgBw +
				", x5kmProspectMaxBw=" + x5kmProspectMaxBw +
				", x2kmProspectAvgDist=" + x2kmProspectAvgDist +
				", cpeVariant='" + cpeVariant + '\'' +
				", x5kmCustCount=" + x5kmCustCount +
				", sumNoOfSitesUniLen=" + sumNoOfSitesUniLen +
				", x05kmProspectPercFeasible=" + x05kmProspectPercFeasible +
				", pOPTCLAccess='" + pOPTCLAccess + '\'' +
				", x05kmProspectCount=" + x05kmProspectCount +
				", probabililtyAccessFeasibility=" + probabililtyAccessFeasibility +
				", lmNrcBwOnrf=" + lmNrcBwOnrf +
				", quotetypeQuote='" + quotetypeQuote + '\'' +
				", popAddress='" + popAddress + '\'' +
				", x2kmMinDist=" + x2kmMinDist +
				", fATGTCLAccess='" + fATGTCLAccess + '\'' +
				", networkFNFHHFlag='" + networkFNFHHFlag + '\'' +
				", closestProviderSiteAddr='" + closestProviderSiteAddr + '\'' +
				", otcTikona=" + otcTikona +
				", closestProviderSite='" + closestProviderSite + '\'' +
				", offnet5kmMinAccuracyNum=" + offnet5kmMinAccuracyNum +
				", interimBW=" + interimBW +
				", offnet5kmMinDistanceKilometers=" + offnet5kmMinDistanceKilometers +
				", offnet05kmMaxBWMbps=" + offnet05kmMaxBWMbps +
				", prospect05kmMinBWMbps=" + prospect05kmMinBWMbps +
				", bwFlag32=" + bwFlag32 +
				", arcTikona=" + arcTikona +
				", minMastHt=" + minMastHt +
				", offnet2kmMinDistanceKilometers=" + offnet2kmMinDistanceKilometers +
				", prospect2kmFeasibilityPct=" + prospect2kmFeasibilityPct +
				", bwFlag3=" + bwFlag3 +
				", offnet2kmCustCount=" + offnet2kmCustCount +
				", prospect2kmAvgDistanceKilometers=" + prospect2kmAvgDistanceKilometers +
				", offnet5kmMaxBWMbps=" + offnet5kmMaxBWMbps +
				", prospect2kmSumFeasibilityFlag=" + prospect2kmSumFeasibilityFlag +
				", arcSify=" + arcSify +
				", prospect2kmAvgBWMbps=" + prospect2kmAvgBWMbps +
				", maxMastHt=" + maxMastHt +
				", providerTotTowers=" + providerTotTowers +
				", offnet2kmMinBWMbps=" + offnet2kmMinBWMbps +
				", offnet05kmMinBWMbps=" + offnet05kmMinBWMbps +
				", offnet5kmAvgBWMbps=" + offnet5kmAvgBWMbps +
				", prospect05kmSumFeasibilityFlag=" + prospect05kmSumFeasibilityFlag +
				", prospect2kmCustCount=" + prospect2kmCustCount +
				", prospect2kmMaxBWMbps=" + prospect2kmMaxBWMbps +
				", otcSify=" + otcSify +
				", providerMinDist=" + providerMinDist +
				", offnet5kmMinBWMbps=" + offnet5kmMinBWMbps +
				", avgMastHt=" + avgMastHt +
				", prospect05kmFeasibilityPct=" + prospect05kmFeasibilityPct +
				", prospect05kmMaxBWMbps=" + prospect05kmMaxBWMbps +
				", offnet05kmMinAccuracyNum=" + offnet05kmMinAccuracyNum +
				", closestProvider='" + closestProvider + '\'' +
				", nearestMastHtCost=" + nearestMastHtCost +
				", offnet2kmAvgBWMbps=" + offnet2kmAvgBWMbps +
				", offnet2kmMinAccuracyNum=" + offnet2kmMinAccuracyNum +
				", custCount=" + custCount +
				", offnet05kmAvgBWMbps=" + offnet05kmAvgBWMbps +
				", closestProviderBsoName='" + closestProviderBsoName + '\'' +
				", prospect05kmMinDistanceKilometers=" + prospect05kmMinDistanceKilometers +
				", nearestMastHt=" + nearestMastHt +
				", prospect2kmMinBWMbps=" + prospect2kmMinBWMbps +
				", offnet05kmMinDistanceKilometers=" + offnet05kmMinDistanceKilometers +
				", offnet05kmCustCount=" + offnet05kmCustCount +
				", prospect05kmAvgBWMbps=" + prospect05kmAvgBWMbps +
				", mast3KMAvgMastHt='" + mast3KMAvgMastHt + '\'' +
				", solutionType='" + solutionType + '\'' +
				", p2PBts3kmRadius='" + p2PBts3kmRadius + '\'' +
				", pMPBts3kmRadius='" + pMPBts3kmRadius + '\'' +
				", btsMinDistKm='" + btsMinDistKm + '\'' +
				", btsNumBTS='" + btsNumBTS + '\'' +
				", cuLeId='" + cuLeId + '\'' +
				", siteFlag='" + siteFlag + '\'' +
				", sectorNetworkCheck='" + sectorNetworkCheck + '\'' +
				", selectedSolutionBw='" + selectedSolutionBw + '\'' +
				", productDotNme='" + productDotNme + '\'' +
				", onnet0_5kmAvgBwMbps='" + onnet0_5kmAvgBwMbps + '\'' +
				", onnet0_5kmCustCount='" + onnet0_5kmCustCount + '\'' +
				", onnet0_5kmMinDistanceKilometers='" + onnet0_5kmMinDistanceKilometers + '\'' +
				", onnet2kmAvgBwMbps='" + onnet2kmAvgBwMbps + '\'' +
				", onnet2kmAvgDistancekilometers='" + onnet2kmAvgDistancekilometers + '\'' +
				", onnet2kmCustCount='" + onnet2kmCustCount + '\'' +
				", onnet2kmMaxBwMbps='" + onnet2kmMaxBwMbps + '\'' +
				", onnet2kmMinBwMbps='" + onnet2kmMinBwMbps + '\'' +
				", onnet5kmAvgBwMbps='" + onnet5kmAvgBwMbps + '\'' +
				", onnet5kmAvgDistanceKilometers='" + onnet5kmAvgDistanceKilometers + '\'' +
				", onnet5kmCustCount='" + onnet5kmCustCount + '\'' +
				", onnet5kmMaxBwMbps='" + onnet5kmMaxBwMbps + '\'' +
				", onnet5kmMinBwMbps='" + onnet5kmMinBwMbps + '\'' +
				", mux='" + mux + '\'' +
				", mast3kmCustCount='" + mast3kmCustCount + '\'' +
				", mast3kmMaxMastHt='" + mast3kmMaxMastHt + '\'' +
				", mast3kmMinMastHt='" + mast3kmMinMastHt + '\'' +
				", mast3kmNearestMastHt='" + mast3kmNearestMastHt + '\'' +
				", lmOtcInr='" + lmOtcInr + '\'' +
				", lmArcInr='" + lmArcInr + '\'' +
				", lmCost='" + lmCost + '\'' +
				", hubNode='" + hubNode + '\'' +
				...
				", coreRing='" + coreRing + '\'' +
				", bandwidth='" + bandwidth + '\'' +
				", btsClosestInfraProvider='" + btsClosestInfraProvider + '\'' +
				", btsClosestSiteType='" + btsClosestSiteType + '\'' +
				", btsFlag='" + btsFlag + '\'' +
				", btsIpPmp='" + btsIpPmp + '\'' +
				", backhaulNetworkCheck='" + backhaulNetworkCheck + '\'' +
				", backhaulNetworkCheckReason='" + backhaulNetworkCheckReason + '\'' +
				", avg3kmMastHtCost='" + avg3kmMastHtCost + '\'' +
				", accessRingsHh='" + accessRingsHh + '\'' +
				...
				", muxIp='" + muxIp + '\'' +
				", muxPort='" + muxPort + '\'' +
				", selectedAccessRing='" + selectedAccessRing + '\'' +
				", btsLat='" + btsLat + '\'' +
				", btsLong='" + btsLong + '\'' +
				", btsSiteName='" + btsSiteName + '\'' +
				", BHCapacity='" + BHCapacity + '\'' +
				", BH_Type='" + BH_Type + '\'' +
				", BHConnectivity='" + BHConnectivity + '\'' +
				", btsDeviceType='" + btsDeviceType + '\'' +
				", btsAzimuth='" + btsAzimuth + '\'' +
				", sectorId='" + sectorId + '\'' +
				", SECTORNAME='" + SECTORNAME + '\'' +
				", version='" + version + '\'' +
				", userName='" + userName + '\'' +
				", userType='" + userType + '\'' +
				", prowCostType='" + prowCostType + '\'' +
				", ProwMessage='" + ProwMessage + '\'' +
				", prowFlag='" + prowFlag + '\'' +
				", lmArcProwGponOnwl='" + lmArcProwGponOnwl + '\'' +
				", lmNrcProwGponOnwl='" + lmNrcProwGponOnwl + '\'' +
				", lmArcProwProwOnwl='" + lmArcProwProwOnwl + '\'' +
				", lmNrcProwProwOnwl='" + lmNrcProwProwOnwl + '\'' +
				", otcModemCharges='" + otcModemCharges + '\'' +
				", lmNrcBWProvOfwl='" + lmNrcBWProvOfwl + '\'' +
				", arcModemCharges='" + arcModemCharges + '\'' +
				", arcBw='" + arcBw + '\'' +
				...
				", lmArcColocationOnrf='" + lmArcColocationOnrf + '\'' +
				...
				", primaryBtsIpAddress='" + primaryBtsIpAddress + '\'' +
				", primaryBtsName='" + primaryBtsName + '\'' +
				", primaryFirstSectorId='" + primaryFirstSectorId + '\'' +
				", deliveryTimeLine='" + deliveryTimeLine + '\'' +
				", feasibilityRemarks='" + feasibilityRemarks + '\'' +
				", izoInternetWan='" + izoInternetWan + '\'' +
				", responseType='" + responseType + '\'' +
				", validityPeriod='" + validityPeriod + '\'' +
				", feasibilityResponseId='" + feasibilityResponseId + '\'' +
				", providerResponseDate='" + providerResponseDate + '\'' +
				", mastType='" + mastType + '\'' +
				...
				", accessFeasibilityUpdated='" + accessFeasibilityUpdated + '\'' +
				", isColo='" + isColo + '\'' +
				", isDemo='" + isDemo + '\'' +
				", demoType='" + demoType + '\'' +
				", errorMsgDisplay='" + errorMsgDisplay + '\'' +
				", selectedAccessRings=" + selectedAccessRings +
				", bwSelectedAccessRings=" + bwSelectedAccessRings +
				", bwSelectedAccessRing='" + bwSelectedAccessRing + '\'' +
				", muxDetails=" + muxDetails +
				'}';
	}
