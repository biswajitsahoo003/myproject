...
/**
 * 
 * This file contains the MultiVrfPrimaryBean.java class.
 * 
 *
 * @author NITHYA S
 ...
 */
public class MultiVrfPrimaryBean {
	...
	public void setIsLmCharges(Boolean isLmChanrges) {
		this.isLmCharges = isLmChanrges;
	}
	...
	public String toString() {
		return "MultiVrfPrimaryBean [localLoopBandwidth=" + localLoopBandwidth + ", totalPortSize=" + totalPortSize
