...
public class GscQuoteDataBean {
	...
	private String multiMacdTrunkDataType;
	...
	public String getMultiMacdTrunkDataType() {
		return multiMacdTrunkDataType;
	}

	public void setMultiMacdTrunkDataType(String multiMacdTrunkDataType) {
		this.multiMacdTrunkDataType = multiMacdTrunkDataType;
	}
	...
	public String toString() {
		return "GscQuoteDataBean{" +
				...
				", secsId='" + secsId + '\'' +
				", multiMacdTrunkDataType='" + multiMacdTrunkDataType + '\'' +
