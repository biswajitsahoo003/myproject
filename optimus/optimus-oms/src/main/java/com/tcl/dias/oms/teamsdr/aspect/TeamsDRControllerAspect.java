package com.tcl.dias.oms.teamsdr.aspect;
...
/**
 * Controller aspect class for all teamsdr controllers
 *
 * @author Syed Ali
...
@Component
@Order(1)
public class TeamsDRControllerAspect {
	private static final Logger LOGGER = LoggerFactory.getLogger(TeamsDRControllerAspect.class);
	...
	@Pointcut("execution(* com.tcl.dias.oms.teamsdr.controller.v1.TeamsDRQuoteController.*(..))")
	public void allTeamsDRQuoteMethod() {
	}

	@Pointcut("execution(* com.tcl.dias.oms.teamsdr.controller.v1.TeamsDROrderController.*(..))")
	public void allTeamsDROrderMethod() {
	}

	/**
	 * Around advice for for all quote methods and controller.
	 *
	 * @param joinPoint
	 * @return
	 * @throws Throwable
	 */
	@Around("controller() && allTeamsDRQuoteMethod()")
	...
	/**
	 * Method to get all customer mapper details
	 *
	...
	/**
	 * Method to validate quotetole id.
	 *
	 * @param quoteLeId
	 * @param customerLeIds
	 * @param quote
	...
	/**
	 * Method to validate docusign sent or not..
	 *
	 * @param quote
	 * @param method
	 * @throws TclCommonException
	...
	/**
	 * Around advice for all order methods and controller
	 *
	 * @param joinPoint
	 * @return
	 * @throws Throwable
	 */
	@Around("controller() && allTeamsDROrderMethod()")
