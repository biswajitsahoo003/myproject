...
public class OrderGdesiteDto {
	...
	public OrderGdesiteDto(OrderIllSite orderIllSite) {
	...
	public String toString() {
		return "OrderNplsiteDto [id=" + id + ", erfLocSiteaLocationId=" + erfLocSiteaLocationId
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OrderGdesiteDto other = (OrderGdesiteDto) obj;
