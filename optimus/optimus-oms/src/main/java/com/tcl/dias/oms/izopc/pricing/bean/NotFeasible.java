...
/**
 * Process the not feasible sites
...
@JsonPropertyOrder({ "lm_nrc_ospcapex_onwl", "Service_ID", "hh_name", "total_cost", "X0.5km_avg_dist", "POP_DIST_KM",
		...
		"prospect_0_5km_Avg_BW_Mbps", "country", "siteFlag", "backup_port_requested", "cu_le_id","Mast_3KM_avg_mast_ht","solution_type",
	    "P2P_bts_3km_radius", "PMP_bts_3km_radius", "bts_min_dist_km","bts_num_BTS","datacentre_location", "cloud_provider", "service_id","version","error_msg_display",
	    // PIPF152
	 	"feasibility_response_id","trigger_feasibility","macd_option",
