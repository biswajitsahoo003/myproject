package com.tcl.dias.oms.aspect;
...
@Component
@Order(1)
public class CommercialControllerAspect {

	private static final Logger LOGGER = LoggerFactory.getLogger(CommercialControllerAspect.class);
	...
	@Pointcut("execution(* com.tcl.dias.oms.ill.controller.v1.IllOrderController.*(..))")
	protected void allIllOrderMethod() {
		// Point cut definition
	}

	@Pointcut("execution(* com.tcl.dias.oms.dashboard.controller.v1.DashboardController.*(..))")
	protected void allIllDashboardMethod() {
		// Point cut definition
	}

	@Pointcut("execution(* com.tcl.dias.oms.ill.controller.v1.IllQuoteController.*(..))")
	protected void allIllQuoteMethod() {
		// Point cut definition
	}
	
	@Pointcut("execution(* com.tcl.dias.oms.ill.macd.controller.v1.IllMACDController.*(..))")
	protected void allIllMACDMethod() {
		// Point cut definition
	}

	@Pointcut("execution(* com.tcl.dias.oms.gvpn.macd.controller.v1.GvpnMACDController.*(..))")
	protected void allGvpnMACDMethod() {
		// Point cut definition
	}
	...
	@Around("controller() && allIllDashboardMethod()")
	...
	@Around("controller() && allIllOrderMethod()")
	...
	@Around("controller() && allIllQuoteMethod() && allIllMACDMethod() && allGvpnMACDMethod()")
