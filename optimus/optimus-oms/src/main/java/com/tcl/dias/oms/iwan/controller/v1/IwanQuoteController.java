 ...
 * the API's related to Quotes for IWAN product
 *
 * @author Manojkumar R
 ...
 */
@RestController
@RequestMapping("/v1/iwan/quotes")
public class IwanQuoteController {

	private static final Logger LOGGER = LoggerFactory.getLogger(IwanQuoteController.class);
	...
	public ResponseResource<QuoteResponse> createQuote(@RequestBody QuoteDetail request,
		...
		QuoteResponse response = iwanQuoteService.createQuote(request, customerId,ns);
	...
	public ResponseResource<QuoteBean> updateSiteInformation(@PathVariable("quoteId") Integer quoteId,
		...
		QuoteBean response = iwanQuoteService.updateSite(request, customerId, quoteId, isColo);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	}
	...
	public ResponseResource<ServiceResponse> shareQuote(@PathVariable("quoteId") Integer quoteId,
			...
			throws TclCommonException {
		ServiceResponse response = iwanQuoteService.processMailAttachment(email, quoteId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	}
	...
	public ResponseResource<QuoteBean> getQuoteConfiguration(@PathVariable("quoteId") Integer quoteId,
			...
			throws TclCommonException {
		QuoteBean response = iwanQuoteService.getQuoteDetails(quoteId, feasibleSites, siteproperities, null, null);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	}
	...
	public ResponseResource<CreateDocumentDto> createDocument(@PathVariable("quoteId") Integer quoteId,
			...
			throws TclCommonException {
		CreateDocumentDto documentDto = iwanQuoteService.createDocument(request);
	...
	public ResponseResource<QuoteDetail> deactivateSites(@PathVariable("quoteId") Integer quoteId,
		...
		QuoteDetail response = iwanQuoteService.processDeactivateSites(siteId, quoteId, action);
	...
	public ResponseResource<TriggerEmailResponse> triggerEmail(@PathVariable("quoteId") Integer quoteId,
		...
		TriggerEmailResponse triggerEmailResponse = iwanQuoteService.processTriggerMail(triggerEmailRequest,
				forwardedIp);
	...
	public ResponseResource<TriggerEmailResponse> getCustomerEmailIdTriggerEmail(
			...
			throws TclCommonException {
		TriggerEmailResponse response = iwanQuoteService.getEmailIdAndTriggerEmail(quoteId, quoteLeId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	...
	public ResponseResource<QuoteResponse> getSiteInfo(@PathVariable("quoteId") Integer quoteId,
		...
		QuoteResponse quoteResponse = iwanQuoteService.getSiteInfo(siteId);
	...
	public ResponseResource<QuoteDelegationDto> getDelegatedUser() throws TclCommonException {
		...
		QuoteDelegationDto quoteDelegationDto = iwanQuoteService.getQuoteDelegation();
	...
	public ResponseResource<QuoteResponse> getTaxExemptedSiteInfo(@PathVariable("quoteId") Integer quoteId,
		...
		QuoteResponse quoteResponse = iwanQuoteService.getTaxExemptedSite(quoteId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, quoteResponse,
				Status.SUCCESS);
	...
	public ResponseResource<List<QuoteBean>> getQuotesDetailsBasedOnCustomer(
		...
		List<QuoteBean> response = iwanQuoteService.getQuotesDetailsBasedOnCustomer(customerId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	}
	...
	public ResponseResource<List<QuoteBean>> getQuotesDetailsBasedOnCustomerLegalEntity(
		...
		List<QuoteBean> response = iwanQuoteService.getQuotesDetailsBasedOnCustomerLegalEntity(customerLegalEntityId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	...
	public ResponseResource<QuoteDetail> editSites(@PathVariable("quoteId") Integer quoteId,
		...
		QuoteDetail response = iwanQuoteService.editSiteComponent(request);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	...
	public ResponseResource<QuoteDetail> approvedQuotes(@RequestBody UpdateRequest request,
			HttpServletRequest httpServletRequest) throws TclCommonException {
		String forwardedIp = httpServletRequest.getHeader(CommonConstants.XFORWARDEDFOR_HEADER);
		QuoteDetail response = iwanQuoteService.approvedQuotes(request, forwardedIp);
		if (o2cEnableFlag.equalsIgnoreCase("true")) {
			LOGGER.info("Entering order to flat table as the flag set was :::: {}", o2cEnableFlag);
			//iwanQuoteService.processOrderFlatTable(response.getOrderId());
		} else {
	...
	public ResponseResource<DashBoardBean> getDashboardDetails(
		...
		DashBoardBean response = iwanQuoteService.getDashboardDetails(legalEntityId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	...
	public ResponseResource<QuoteDetail> updateSiteProperties(@PathVariable("quoteId") Integer quoteId,
			...
			@RequestBody UpdateRequest request) throws TclCommonException {
		QuoteDetail response = iwanQuoteService.updateSiteProperties(request);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	...
	public ResponseResource<QuoteDetail> updateSitePropertiesAttributes(@PathVariable("quoteId") Integer quoteId,
			@PathVariable("quoteToLeId") Integer quoteLeId, @PathVariable("siteId") Integer siteId,
			@RequestBody UpdateRequest request) throws TclCommonException {
		QuoteDetail response = iwanQuoteService.updateSitePropertiesAttributes(request);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	 ...
	 * @throws TclCommonException
	 */
	@ApiOperation(value = SwaggerConstants.ApiOperations.Quotes.RESET_MF_TASK_TRIGGERED)
	@RequestMapping(value = "/{quoteId}/le/{quoteLeId}/sites/{siteId}/resetMfTaskTriggered", method = RequestMethod.POST)
	@ApiResponses(value = { @ApiResponse(code = 200, message = Constants.SUCCESS),
			@ApiResponse(code = 403, message = Constants.FORBIDDEN),
			@ApiResponse(code = 422, message = Constants.NOT_FOUND),
			@ApiResponse(code = 417, message = Constants.EXCEPTION_FAILED) })
	public ResponseResource<QuoteDetail> updateSiteResetMfTaskTriggeredAttribute(@PathVariable("quoteLeId") Integer quoteToLeId,
			@PathVariable("quoteId") Integer quoteId,@PathVariable("siteId") Integer siteId) throws TclCommonException {
		iwanQuoteService.updateSiteResetMfTaskTriggered(siteId);
	...
	public ResponseResource<List<QuoteProductComponentBean>> getSiteProperties(@PathVariable("quoteId") Integer quoteId,
			@PathVariable("quoteToLeId") Integer quoteLeId, @PathVariable("siteId") Integer siteId)
			throws TclCommonException {
		List<QuoteProductComponentBean> response = iwanQuoteService.getSiteProperties(quoteLeId, siteId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	}
	...
	public ResponseResource<QuoteDetail> updateLegalEntityProperties(@PathVariable("quoteId") Integer quoteId,
			...
			throws TclCommonException {
		QuoteDetail response = iwanQuoteService.updateLegalEntityProperties(request);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	...
	public ResponseResource<Set<LegalAttributeBean>> getAllAttributesByQuoteToLeId(
			...
			throws TclCommonException {
		Set<LegalAttributeBean> response = iwanQuoteService.getAllAttributesByQuoteToLeId(quoteToLeId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	...
	public ResponseResource<QuoteDetail> persistListOfQuoteLeAttributes(@PathVariable("quoteId") Integer quoteId,
			...
			throws TclCommonException {
		QuoteDetail response = iwanQuoteService.persistListOfQuoteLeAttributes(request,quoteToLeId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	...
	public ResponseResource<QuoteDetail> updateQuoteToLeStatus(@PathVariable("quoteLeId") Integer quoteToLeId,
		...
		QuoteDetail response = iwanQuoteService.updateQuoteToLeStatus(quoteToLeId, status);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	...
	public ResponseResource<String> updateSdfcStage(@PathVariable("quoteId") Integer quoteId,
			...
			throws TclCommonException {
		iwanQuoteService.updateSfdcStage(quoteToLeId, stage);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS,
				Status.SUCCESS.toString(), Status.SUCCESS);
	...
	public ResponseResource<ContactAttributeInfo> getContactAttributeDetails(@PathVariable("quoteId") Integer quoteId,
		...
		ContactAttributeInfo response = iwanQuoteService.getContactAttributeDetails(quoteLeId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	...
	public ResponseResource<String> updateCurrency(@PathVariable("quoteId") Integer quoteId,
			...
			throws TclCommonException {
		iwanQuoteService.updateCurrency(quoteId, quoteToLeId, inputCurrency);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS,
				Status.SUCCESS.toString(), Status.SUCCESS);
	...
	public ResponseEntity<String> triggerAccountManagerCofDownloadNotification(@PathVariable("quoteId") Integer quoteId,
			@PathVariable("quoteLeId") Integer quoteToLeId) throws TclCommonException {
		iwanQuoteService.cofDownloadAccountManagerNotification(quoteId, quoteToLeId);
		return null;
	...
	public ResponseResource<TriggerEmailResponse> deletegateUserForSalesUserLogin(
			...
			HttpServletRequest httpServletRequest) throws TclCommonException {
		String forwardedIp = httpServletRequest.getHeader(CommonConstants.XFORWARDEDFOR_HEADER);
		TriggerEmailResponse response = iwanQuoteService.delegateUserForSalesLogin(quoteToLeId, forwardedIp);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	}
	...
	public ResponseResource<String> generateQuotePdf(@PathVariable("quoteId") Integer quoteId,
		...
		String tempDownloadUrl = iwanQuotePdfService.processQuotePdf(quoteId, response, quoteToLeId);
	...
	public ResponseResource<String> generateCofPdf(@PathVariable("quoteId") Integer quoteId,
		...
		iwanQuotePdfService.processCofPdf(quoteId, response, nat, false, quoteToLeId, null);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS,
				Status.SUCCESS.toString(), Status.SUCCESS);
	}
	...
	public ResponseResource<QuoteIllSitesWithFeasiblityAndPricingBean> getFeasiblityAndPricingDetailsForQuoteIllSites(
		...
		QuoteIllSitesWithFeasiblityAndPricingBean response = iwanQuoteService
	...
	public ResponseResource<OmsAttachmentBean> updateCofUploadedDetails(@PathVariable("quoteId") Integer quoteId,
		...
		OmsAttachmentBean omsAttachmentBean = iwanQuotePdfService.updateCofUploadedDetails(quoteId, quoteLeId, requestId,
				url);
	...
	public ResponseResource<List<OmsAttachmentBean>> moveFilesToObjectStorage() throws TclCommonException {
		List<OmsAttachmentBean> omsAttachmentBeanList = iwanQuoteService.moveFilesToObjectStorage();
	...
	public ResponseResource<String> updateTermAndMonths(@PathVariable("quoteId") Integer quoteId,
			...
			throws TclCommonException {
		iwanQuoteService.updateLconProperities(quoteId, quoteToLeId, lconUpdateBeans);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS,
				Status.SUCCESS.toString(), Status.SUCCESS);
	...
	public ResponseResource<QuoteDetail> approvedQuotesHardFix(@RequestBody UpdateRequest request,
			HttpServletRequest httpServletRequest) throws TclCommonException {
		String forwardedIp = httpServletRequest.getHeader(CommonConstants.XFORWARDEDFOR_HEADER);
		QuoteDetail response = iwanQuoteService.approvedQuotesForHardFix(request, forwardedIp);
		if (o2cEnableFlag.equalsIgnoreCase("true")) {
			LOGGER.info("Entering order to flat table as the flag set was :::: {}", o2cEnableFlag);
			//iwanQuoteService.processOrderFlatTable(response.getOrderId());
		} else {
	...
	public ResponseResource<String> removeUnselectedSolutionsFromQuote(@PathVariable("quoteId") Integer quoteId,
			...
			throws TclCommonException {
		iwanQuoteService.removeUnselectedSolutionsFromQuote(quoteId, quoteLeId, profilesToRemove);
	...
	public ResponseResource<String> processDocusignWithApprover(@PathVariable("quoteId") Integer quoteId,
		...
		iwanQuotePdfService.processDocusign(quoteId, quoteToLeId, nat, emailId, name, approvers);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS,
				Status.SUCCESS.toString(), Status.SUCCESS);
	...
	public ResponseResource<QuoteDetail> processAskPrice(@PathVariable("quoteId") Integer quoteId,
			...
			@RequestBody UpdateRequest request) throws TclCommonException {
		QuoteDetail response = iwanPricingFeasibilityService.processAskPrice(siteCode, quoteToLeId, request, quoteId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	...
	public ResponseResource<Boolean> getDiscountDetails(@PathVariable("quoteLeId") Integer quoteToLeId,
		...
		Boolean response = iwanPricingFeasibilityService.triggerWorkFlow(quoteToLeId, siteCodes);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	...
	public ResponseResource<CommonValidationResponse> processCofValidator(@PathVariable("quoteId") Integer quoteId,
			@PathVariable("quoteToLeId") Integer quoteToLeId) throws TclCommonException {
		CommonValidationResponse response = iwanQuoteService.processValidate(quoteId, quoteToLeId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
...
/**
	...
	public ResponseResource<String> upLoadSiteDocument(@RequestParam("file") MultipartFile file,
			...
			@PathVariable("siteId") Integer siteId) throws TclCommonException {
		String response = iwanQuoteService.uploadDocument(siteId, file);
  ...
  /**
	...
	public ResponseResource<String> downloadSiteDocument(@PathVariable("siteId") Integer siteId, HttpServletResponse response) throws TclCommonException, IOException {
		String fileName = iwanQuoteService.downloadDocument(siteId, response);
  ...
  /**
	...
	public ResponseResource<List<SiteDocumentBean>> getSiteDocumentsForQuoteLe(@PathVariable("quoteId") Integer quoteId) throws TclCommonException, IOException {
		List<SiteDocumentBean> siteDocNames = iwanQuoteService.getSiteDocumentDetails(quoteId);
...
/**
	...
	public ResponseResource<String> processManualFeasibilityFlow(@PathVariable("quoteToLe") Integer quoteToLe,
		...
		iwanPricingFeasibilityService.processManualFeasibilityRequest(manualFeasibilitySiteBean, quoteToLe);
	...
	public ResponseResource<List<String>> getMfSupportGroup(@PathVariable("quoteId") Integer quoteId, @PathVariable("siteId") Integer siteId) throws TclCommonException {
		OpportunityBean response = iwanQuoteService.getOpportunityDetails(quoteId,siteId);
		response = iwanQuoteService.retrievePriSecSIDsForMFOppurtunity(response,quoteId,siteId);
		return new ResponseResource(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	}
	...
	public ResponseResource<String> processMFForFeasibleSites(@PathVariable("quoteToLe") Integer quoteToLe,
			@RequestBody List<ManualFeasibilitySiteBean> manualFeasibilitySiteBean) throws TclCommonException {
		iwanPricingFeasibilityService.processMFRequestForFeasibleSites(manualFeasibilitySiteBean, quoteToLe);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, Constants.SUCCESS,
				Status.SUCCESS);
	}
	...
	public  ResponseResource<String> downloadEnrichmentDetails(HttpServletResponse response, @RequestParam("code") String quoteCode) throws DocumentException, IOException, TclCommonException {
		iwanQuoteService.downloadEnrichmentDetails(response, quoteCode);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS,
				Status.SUCCESS.toString(), Status.SUCCESS);
	...
	public ResponseResource<String> processFeasibilityTriggeredByCustomer(@PathVariable("quoteToLe") Integer quoteToLe,
		...
		iwanPricingFeasibilityService.processCustomerTriggeredFeasibility(quoteToLe);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, Constants.SUCCESS,
				Status.SUCCESS);
	}
 ...
 */
	...
	public ResponseResource<String> persistDemoOrder(@PathVariable("quoteToLe") Integer quoteToLe,
		...
		iwanQuoteService.persistDemoOrderInfo(quoteToLe,info);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, Constants.SUCCESS,
				Status.SUCCESS);
	}
	...
	public ResponseResource<CommonValidationResponse> validateSubCategoryForNSQuotes(@PathVariable("quoteId") Integer quoteId) throws TclCommonException {
		CommonValidationResponse response = iwanQuoteService.validateSubCategoryForNSQuotes(quoteId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
				Status.SUCCESS);
	}
	...
	public ResponseResource< List<LMDetailBean>>getLMProvider(@PathVariable("quoteLeId") Integer quoteLeId,@PathVariable("siteId") Integer siteId) throws TclCommonException {
		List<LMDetailBean> lmDetails = iwanQuoteService.getLMProvider(quoteLeId,siteId);
	...
	public ResponseResource<List<LeOwnerDetailsSfdc>>getLeOwnerDetails(@PathVariable("customerId") Integer customerId, @PathVariable("quoteId") Integer quoteId) throws TclCommonException {
		List<LeOwnerDetailsSfdc> ownerDetails = iwanQuoteService.getOwnerDetailsForSfdc(customerId,quoteId);
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 422, message = Constants.NOT_FOUND),
            @ApiResponse(code = 417, message = Constants.EXCEPTION_FAILED)})
    @PostMapping(value = "/update/quoteToLe/{quoteLeId}/customerLe/{customerLeId}", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResponseResource<Boolean> updatePartnerLeLocation(@PathVariable("quoteLeId") Integer quoteLeId, @PathVariable("customerLeId") Integer customerLeId)
            throws TclCommonException {
        Boolean response = iwanQuoteService.updatePartnerLeLocation(quoteLeId, customerLeId);
        return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, response,
                Status.SUCCESS);
    }
     ...
     * @throws TclCommonException
     */
    @ApiOperation(value = SwaggerConstants.ApiOperations.Quotes.DELETE_ATTRIBUTE)
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = Constants.SUCCESS, response = Boolean.class),
            @ApiResponse(code = 403, message = Constants.FORBIDDEN),
            @ApiResponse(code = 422, message = Constants.NOT_FOUND),
            @ApiResponse(code = 417, message = Constants.EXCEPTION_FAILED)})
    @PostMapping(value = "/{quoteId}/site/{siteId}/attribute/delete", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResponseResource<Boolean> deleteAttribute(@PathVariable("quoteId") Integer quoteId,@PathVariable("siteId") Integer siteId, @RequestBody() AttributeRequest attributeRequest)
            throws TclCommonException {
        iwanQuoteService.deleteAttribute(quoteId,siteId,attributeRequest);
        return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS,
                Status.SUCCESS);
    }
    
    @ApiOperation(value = SwaggerConstants.ApiOperations.Quotes.DOWNLOAD_SERVICE_SCHEDULE)
	@ApiResponses(value = { @ApiResponse(code = 200, message = Constants.SUCCESS),
			@ApiResponse(code = 403, message = Constants.FORBIDDEN),
			@ApiResponse(code = 422, message = Constants.NOT_FOUND),
			@ApiResponse(code = 417, message = Constants.EXCEPTION_FAILED) })
	...
	public ResponseResource<String> getAttachmentSS(@RequestParam(required = false,name= "qc") String key,
		...
		String url = iwanQuoteService.processSSDownloadFile(key,id);
	...
	/**
	 * Api to update product in SFDC
	 * @param quoteId
	 * @param quoteToLeId
	 * @return
	 * @throws TclCommonException
	 */
	@ApiOperation(value = SwaggerConstants.ApiOperations.Quotes.UPDATE_PRODUCT_IN_SFDC)
	@ApiResponses(value = {@ApiResponse(code = 200, message = Constants.SUCCESS, response = Boolean.class),
			@ApiResponse(code = 403, message = Constants.FORBIDDEN),
			@ApiResponse(code = 422, message = Constants.NOT_FOUND),
			@ApiResponse(code = 417, message = Constants.EXCEPTION_FAILED)})
	@GetMapping(value = "/{quoteId}/le/{quoteToLeId}/updateProductInSFDC", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseResource<Boolean> updateProductInSFDC(@PathVariable("quoteId") Integer quoteId,
													   @PathVariable("quoteToLeId") Integer quoteToLeId) throws TclCommonException {
		iwanQuoteService.updateProductInSFDC(quoteToLeId);
		return new ResponseResource<>(ResponseResource.R_CODE_OK, ResponseResource.RES_SUCCESS, true, Status.SUCCESS);
	}
}
