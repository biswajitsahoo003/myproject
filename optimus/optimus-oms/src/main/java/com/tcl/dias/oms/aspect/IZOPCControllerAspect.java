...
@Component
@Order(1)
public class IZOPCControllerAspect {

	private static final Logger LOGGER = LoggerFactory.getLogger(IZOPCControllerAspect.class);
	...
	@Pointcut("execution(* com.tcl.dias.oms.izopc.controller.v1.IzoPcOrderController.*(..))")
	protected void allIzoPcOrderMethod() {
		// Point cut definition
	}

	@Pointcut("execution(* com.tcl.dias.oms.izopc.controller.v1.IzoPcQuoteController.*(..))")
	protected void allIzoPcQuoteMethod() {
		// Point cut definition
	}
	
	@Pointcut("execution(* com.tcl.dias.oms.izopc.dashboard.controller.v1.IzopcDashboardController.*(..))")
	protected void allIzopcDashboardMethod() {
		// Point cut definition
	}
	...
	@Around("controller() && allIzopcDashboardMethod()")
	...
	@Around("controller() && allIzoPcOrderMethod()")
	...
	@Around("controller() && allIzoPcQuoteMethod()")
