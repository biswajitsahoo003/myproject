...
public class GscQuoteConfigurationBean {
	...
	public String toString() {
		return "GscQuoteConfigurationBean{" +
				...
				", nrc=" + nrc +
				", arc=" + arc +
				", ratePerMinFixed=" + ratePerMinFixed +
				", ratePerMinSpecial=" + ratePerMinSpecial +
				", ratePerMinMobile=" + ratePerMinMobile +
				", ratePerMinute=" + ratePerMinute +
				", terminations=" + terminations +
				", terminationName=" + terminationName +
				", phoneType=" + phoneType +
				", terminationRate=" + terminationRate +
				", productComponents=" + productComponents +
				", numbersPorted=" + numbersPorted +
				", quantityOfNumbers=" + quantityOfNumbers +
				", orderSetupNRC='" + orderSetupNRC + '\'' +
				", domesticDIDMRC='" + domesticDIDMRC + '\'' +
				", concurrentChannelMRC='" + concurrentChannelMRC + '\'' +
				", noOfConcurrentChannel='" + noOfConcurrentChannel + '\'' +
				", uifnRegistrationCharge=" + uifnRegistrationCharge +
				", type='" + type + '\'' +
				'}';
	}
}
