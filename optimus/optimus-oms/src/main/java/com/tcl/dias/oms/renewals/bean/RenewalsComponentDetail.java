...
public class RenewalsComponentDetail implements Serializable {
	...
	private List<RenewalsAttributeDetail> attributes = new ArrayList<>();
	...
	public List<RenewalsAttributeDetail> getAttributes() {
		return attributes;
	}

	public void setAttributes(List<RenewalsAttributeDetail> attributes) {
