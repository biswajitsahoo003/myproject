...
/**
 * Controller aspect class for all webex controllers
 *
...
@Component
@Order(1)
public class WebexControllerAspect {

	private static final Logger LOGGER = LoggerFactory.getLogger(WebexControllerAspect.class);
	...
	@Pointcut("execution(* com.tcl.dias.oms.webex.controller.WebexOrderController.*(..))")
	protected void allWebexOrderMethod() {
		// Point cut definition
	}

	@Pointcut("execution(* com.tcl.dias.oms.webex.controller.WebexQuoteController.*(..))")
	protected void allWebexQuoteMethod() {
		// Point cut definition
	}
	...
	/**
	 * Validate Order Around
	 *
	 * @param joinPoint
	 * @return
	 * @throws Throwable
	 */
	@Around("controller() && allWebexOrderMethod()")
	...
	/**
	 * Validate Quote Around
	 *
	 * @param joinPoint
	 * @return
	 * @throws Throwable
	 */
	@Around("controller() && allWebexQuoteMethod()")
