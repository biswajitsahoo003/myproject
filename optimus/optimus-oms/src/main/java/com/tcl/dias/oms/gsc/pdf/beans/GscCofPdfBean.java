...
public class GscCofPdfBean {
	...
	private String partnerUserAction;
	private Boolean isGppSellThroughPartner= false;
	...
	private List<GscWholesaleInterconnectBean> gscWholesaleInterconnectBeans;
	...
	public String getPartnerUserAction() {
		return partnerUserAction;
	}

	public void setPartnerUserAction(String partnerUserAction) {
		this.partnerUserAction = partnerUserAction;
	}

	public Boolean getIsGppSellThroughPartner() {
		return isGppSellThroughPartner;
	}

	public void setIsGppSellThroughPartner(Boolean gppSellThroughPartner) {
		isGppSellThroughPartner = gppSellThroughPartner;
	}
	...
	public String toString() {
		return "GscCofPdfBean{" +
				...
				", gscMultiMacdServices=" + gscMultiMacdServices +
				", gscWholesaleInterconnectBeans=" + gscWholesaleInterconnectBeans +
				", contractTermSimplified=" + contractTermSimplified +
				", tnc='" + tnc + '\'' +
				", isTnc=" + isTnc +
				", partnerUserAction=" + partnerUserAction +
