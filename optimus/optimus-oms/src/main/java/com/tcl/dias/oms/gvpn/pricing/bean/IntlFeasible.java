...
public class IntlFeasible {
    ...
    @JsonProperty("provider_pop_sites")
    private List<ProviderPopSite> providerPopSites = null;
    ...
    private List<String> tclPopShortCode;
   ...
   private String oldLlBw;
    ...
    public List<ProviderPopSite> getProviderPopSites() { return providerPopSites; }

    public void setProviderPopSites(List<ProviderPopSite> providerPopSites) { this.providerPopSites = providerPopSites; }
