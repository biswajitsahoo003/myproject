...
@JsonPropertyOrder({ "lm_nrc_ospcapex_onwl", "Service_ID", "hh_name", "total_cost", "X0.5km_avg_dist", "POP_DIST_KM",
		"X0.5km_prospect_avg_bw", "OnnetCity_tag", "lm_arc_bw_prov_ofrf", "Network_F_NF_CC", "lm_nrc_nerental_onwl",
		"lm_nrc_inbldg_onwl", "Network_Feasibility_Check", "core_check_CC", "X5km_min_bw", "access_check_CC", "rank",
		"POP_DIST_KM_SERVICE_MOD", "X5km_max_bw", "X5km_prospect_perc_feasible", "lm_arc_bw_onrf", "POP_Category",
		"lm_nrc_bw_prov_ofrf", "FATG_Building_Type", "HH_0_5_access_rings_F", "hh_flag", "local_loop_interface",
		"X5km_prospect_avg_dist", "latitude_final", "FATG_Network_Location_Type", "topology", "city_tier",
		"lm_nrc_bw_onwl", "X2km_prospect_min_dist", "X2km_prospect_perc_feasible", "X0.5km_prospect_num_feasible",
		"cpe_supply_type", "additional_ip_flag", "Orch_Connection", "site_id", "cpe_management_type", "sales_org",
		"opportunity_term", "error_flag", "resp_city", "connected_cust_tag", "net_pre_feasible_flag",
		"Network_F_NF_CC_Flag", "pop_long", "Orch_LM_Type", "ipv4_address_pool_size", "X5km_prospect_avg_bw",
		"FATG_Category", "lm_nrc_mast_ofrf", "X2km_prospect_min_bw", "X5km_prospect_num_feasible", "Selected",
		"pop_name", "lm_nrc_mast_onrf", "X5km_prospect_count", "error_msg", "connection_type", "ip_address_arrangement",
		"X0.5km_avg_bw", "X2km_cust_count", "customer_segment", "FATG_PROW", "time_taken", "connected_building_tag",
		"FATG_DIST_KM", "X0.5km_prospect_max_bw", "X5km_prospect_min_dist", "Type", "FATG_Ring_type", "longitude_final",
		"Orch_BW", "scenario_1", "scenario_2", "access_check_hh", "X2km_prospect_count", "ipv6_address_pool_size",
		"min_hh_fatg", "POP_Construction_Status", "X5km_avg_dist", "X2km_avg_dist", "X2km_prospect_avg_bw",
		"X0.5km_prospect_min_dist", "cost_permeter", "prospect_name", "Predicted_Access_Feasibility", "X2km_max_bw",
		"X2km_prospect_max_bw", "last_mile_contract_term", "X5km_prospect_min_bw", "X2km_min_bw", "burstable_bw",
		"pop_network_loc_id", "bw_mbps", "X0.5km_cust_count", "X0.5km_min_bw", "product_name", "Network_F_NF_HH",
		"HH_0_5_access_rings_NF", "X0.5km_min_dist", "POP_Building_Type", "core_check_hh", "HH_DIST_KM",
		"X0.5km_prospect_min_bw", "error_code", "POP_DIST_KM_SERVICE", "lm_arc_bw_onwl", "num_connected_building",
		"account_id_with_18_digit", "Orch_Category", "X0.5km_prospect_avg_dist", "POP_Network_Location_Type",
		"lm_nrc_mux_onwl", "num_connected_cust", "HH_0_5km", "pop_lat", "X5km_min_dist",
		"feasibility_response_created_date", "X2km_prospect_num_feasible", "X2km_avg_bw", "X0.5km_max_bw",
		"X5km_avg_bw", "X5km_prospect_max_bw", "X2km_prospect_avg_dist", "cpe_variant", "X5km_cust_count",
		"sum_no_of_sites_uni_len", "X0.5km_prospect_perc_feasible", "POP_TCL_Access", "X0.5km_prospect_count",
		"Probabililty_Access_Feasibility", "lm_nrc_bw_onrf", "quotetype_quote", "pop_address", "X2km_min_dist",
		"FATG_TCL_Access", "Network_F_NF_HH_Flag", "closest_provider_site_addr", "otc_tikona", "closest_provider_site",
		"offnet_5km_Min_accuracy_num", "interim_BW", "offnet_5km_Min_DistanceKilometers", "offnet_0_5km_Max_BW_Mbps",
		"prospect_0_5km_Min_BW_Mbps", "bw_flag_32", "arc_tikona", "min_mast_ht", "offnet_2km_Min_DistanceKilometers",
		"prospect_2km_feasibility_pct", "bw_flag_3", "offnet_2km_cust_Count", "prospect_2km_Avg_DistanceKilometers",
		"offnet_5km_Max_BW_Mbps", "prospect_2km_Sum_Feasibility_flag", "arc_sify", "prospect_2km_Avg_BW_Mbps",
		"max_mast_ht", "provider_tot_towers", "offnet_2km_Min_BW_Mbps", "offnet_0_5km_Min_BW_Mbps",
		"offnet_5km_Avg_BW_Mbps", "prospect_0_5km_Sum_Feasibility_flag", "prospect_2km_cust_Count",
		"prospect_2km_Max_BW_Mbps", "otc_sify", "provider_min_dist", "offnet_5km_Min_BW_Mbps", "avg_mast_ht",
		"prospect_0_5km_feasibility_pct", "prospect_0_5km_Max_BW_Mbps", "offnet_0_5km_Min_accuracy_num",
		"closest_provider", "nearest_mast_ht_cost", "offnet_2km_Avg_BW_Mbps", "offnet_2km_Min_accuracy_num",
		"cust_count", "offnet_0_5km_Avg_BW_Mbps", "closest_provider_bso_name", "prospect_0_5km_Min_DistanceKilometers",
		"nearest_mast_ht", "prospect_2km_Min_BW_Mbps", "offnet_0_5km_Min_DistanceKilometers", "offnet_0_5km_cust_Count",
		"prospect_0_5km_Avg_BW_Mbps", "country", "siteFlag", "backup_port_requested", "cu_le_id",
		"Mast_3KM_avg_mast_ht", "solution_type", "P2P_bts_3km_radius", "PMP_bts_3km_radius", "bts_min_dist_km",
		"bts_num_BTS", "product_solution", "macd_service", "ll_change", "macd_option", "trigger_feasibility",
		"old_contract_term", "service_commissioned_date", "lat_long", "service_id", "backup_port_requested","parallel_run_days",
		"old_Port_Bw", "old_Ll_Bw", "cpe_chassis_changed","local_loop_bw", "partner_account_id_with_18_digit",
		"partner_profile",
		"quotetype_partner",
...
public class NotFeasible {
	...
	/**
	 * @param onnet0_5kmMinDistanceKilometers the onnet0_5kmMinDistanceKilometers to
	 *                                        set
	 */
