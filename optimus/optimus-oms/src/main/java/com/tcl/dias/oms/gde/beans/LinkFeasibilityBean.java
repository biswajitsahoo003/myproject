...
public class LinkFeasibilityBean implements Serializable {
	...
	private GdeScheduleDetailBean orderScheduleDetail;
	...
	public GdeScheduleDetailBean getOrderScheduleDetail() {
		return orderScheduleDetail;
	}

	public void setOrderScheduleDetail(GdeScheduleDetailBean orderScheduleDetail) {
		this.orderScheduleDetail = orderScheduleDetail;
	}
