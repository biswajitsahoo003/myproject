...
public class IPCOrdersBean implements Serializable {
	...
	private Boolean isOrderAlreadyImplemented;
	...
	public Boolean getIsOrderAlreadyImplemented() {
		return isOrderAlreadyImplemented;
	}

	public void setIsOrderAlreadyImplemented(Boolean isOrderAlreadyImplemented) {
		this.isOrderAlreadyImplemented = isOrderAlreadyImplemented;
	}
	...
	public String toString() {
		return "OrdersBean [id=" + id + ", orderCode=" + orderCode + ", createdBy=" + createdBy + ", createdTime="
				...
				+ ", orderToLeBeans=" + orderToLeBeans + ", checkList=" + checkList + "]";
	}
