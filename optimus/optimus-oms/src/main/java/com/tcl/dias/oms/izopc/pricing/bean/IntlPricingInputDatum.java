...
public class IntlPricingInputDatum {
    ...
    private String providerNNRCCost;
	...
	public String getProviderNNRCCost() {
		return providerNNRCCost;
	}

	public void setProviderNNRCCost(String providerNNRCCost) {
		this.providerNNRCCost = providerNNRCCost;
	}
