...
@Component
@Order(1)
public class NPLControllerAspect {

	private static final Logger LOGGER = LoggerFactory.getLogger(NPLControllerAspect.class);
	...
	@Pointcut("execution(* com.tcl.dias.oms.npl.controller.v1.NplOrderController.*(..))")
	protected void allNplOrderMethod() {
		// Point cut definition
	}

	@Pointcut("execution(* com.tcl.dias.oms.npl.controller.v1.NplQuoteController.*(..))")
	protected void allNplQuoteMethod() {
		// Point cut definition
	}

	@Pointcut("execution(* com.tcl.dias.oms.npl.dashboard.controller.v1.NplDashboardController.*(..))")
	protected void allNplDashboardMethod() {
		// Point cut definition
	}
	...
	@Around("controller() && allNplDashboardMethod()")
	...
	@Around("controller() && allNplOrderMethod()")
	...
	@Around("controller() && allNplQuoteMethod()")
