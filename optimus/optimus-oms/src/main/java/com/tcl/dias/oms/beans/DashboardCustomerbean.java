...
public class DashboardCustomerbean {
	...
	/**
	 * @param activeQuotesCount
	 *            the activeQuotesCount to set
	 */
	...
	/**
	 * @param activeOrderCount
	 *            the activeOrderCount to set
	 */
	...
	/**
	 * @param legalEntityBeans
	 *            the legalEntityBeans to set
	 */
