...
public class OrderToLeProductFamilyBean implements Serializable {
	...
	private List<IPCOrderProductSolutionBean> orderProductSolutions;
	 ...
	 */
	public List<IPCOrderProductSolutionBean> getOrderProductSolutions() {
	 ...
	 */
	public void setOrderProductSolutions(List<IPCOrderProductSolutionBean> orderProductSolutions) {
