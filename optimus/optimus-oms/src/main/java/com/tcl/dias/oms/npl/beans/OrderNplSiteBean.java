...
public class OrderNplSiteBean implements Serializable {
	 ...
	 * @param site
	 */
	public OrderNplSiteBean(OrderIllSite site) {
		super();
		this.id = site.getId();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OrderNplSiteBean other = (OrderNplSiteBean) obj;
		if (arc == null) {
			if (other.arc != null)
				return false;
