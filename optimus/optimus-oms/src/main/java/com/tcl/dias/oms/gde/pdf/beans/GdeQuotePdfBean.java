...
public class GdeQuotePdfBean {
    ...
    private List<GdeCommercial> commercials;
    private List<GdeSolution> solutions;
    ...
    public List<GdeCommercial> getCommercials() {
        return commercials;
    }

    public void setCommercials(List<GdeCommercial> commercials) {
    ...
    public List<GdeSolution> getSolutions() {
        return solutions;
    }

    public void setSolutions(List<GdeSolution> solutions) {
    ...
    public String getAccessProvider() { return accessProvider; }

    public void setAccessProvider(String accessProvider) { this.accessProvider = accessProvider; }

    public String getLinkType() { return linkType; }

    public void setLinkType(String linkType) { this.linkType = linkType; }

    public String getServiceCombinationType() { return serviceCombinationType; }

    public void setServiceCombinationType(String serviceCombinationType) { this.serviceCombinationType = serviceCombinationType; }
	...
	public String getLeHsnCode() {
		return leHsnCode;
	}

	public void setLeHsnCode(String leHsnCode) {
		this.leHsnCode = leHsnCode;
	}
    ...
    public String toString() {
        return "NplQuotePdfBean{" +
                ...
                ", baseCircuitBw='" + baseCircuitBw + '\'' +
                ", bwOnDemand='" + bwOnDemand + '\'' +
                ", leHsnCode='" + leHsnCode + '\'' +
                '}';
    }
