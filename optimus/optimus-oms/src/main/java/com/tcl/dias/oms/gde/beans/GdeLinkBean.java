...
/**
 * Bean class to hold GDE link related information
 * 
 *
 * @author archchan
...
public class GdeLinkBean implements Serializable {
	...
	private List<QuoteGdeSiteBean> sites;

	private List<QuoteGdeiteDto> sitesDtos;

	private List<OrderGdeSiteBean> orderSites;

	private List<OrderGdesiteDto> orderSitesDtos;
	...
	public GdeLinkBean(OrderNplLink orderNplLinkEntity) {
	...
	public GdeLinkBean(QuoteNplLink quoteNplLinkEntity) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GdeLinkBean other = (GdeLinkBean) obj;
		if (createdBy == null) {
	...
	public List<QuoteGdeSiteBean> getSites() {
		return sites;
	}

	public void setSites(List<QuoteGdeSiteBean> sites) {
		this.sites = sites;
	}

	public List<QuoteGdeiteDto> getSitesDtos() {
		return sitesDtos;
	}

	public void setSitesDtos(List<QuoteGdeiteDto> sitesDtos) {
		this.sitesDtos = sitesDtos;
	}

	public List<OrderGdeSiteBean> getOrderSites() {
		return orderSites;
	}

	public void setOrderSites(List<OrderGdeSiteBean> orderSites) {
		this.orderSites = orderSites;
	}

	public List<OrderGdesiteDto> getOrderSitesDtos() {
		return orderSitesDtos;
	}

	public void setOrderSitesDtos(List<OrderGdesiteDto> orderSitesDtos) {
