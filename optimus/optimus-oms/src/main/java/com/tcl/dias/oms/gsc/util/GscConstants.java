...
public class GscConstants {
	...
	public static final String CITY_WISE_AREA_CODE = "City wise Porting service needed";
...
//	public static final String TIGER_SERVICE_TYPE_INTERCONNECT_ORDER = "INTERCONNECT_ORDER";
	...
	public static final String QUOTE_CODE_NULL_MESSAGE = "Quote Code cannot be null";
	public static final String ORDER_CODE_NULL_MESSAGE = "Order Code cannot be null";
	public static final String GB_NEGOTIATED_PRICES_EXCEL = "GB NEGOTIATED PRICES EXCEL";
	public static final String GSIP_DOMESTIC_OUTBOUND_PDF = "GSIP_Domestic_Outbound_PDF";
	public static final String CHANGE_OUTPULSE_ORDER = "CHANGE_OUTPULSE_ORDER";
	public static final String APAC_EMAIL_CONFIRMATION_PDF = "APAC EMAIL CONFIRMATION PDF";
	...
	public static final String WORKING_TEMPORARY_TERMINATION_NUMBER = "Working Temporary Termination Number";
	
	
	//newly added for Rate file generation in O2C
	public static final String GLOBAL_OUTBOUND_SURCHARGE = "Global Outbound Surcharge Prices";
	public static final String DOMESTIC_VOICE_OUTBOUND_PRICES = "Domestic Voice Outbound Prices";
	public static final String GLOBAL_OUTBOUND_VOICE_PRICES = "Global Outbound Offnet Voice Prices";
	public static final String GSIP_DOMESTIC_OUTBOUND_EXCEL = "GSIP_Domestic_Outbound_EXCEL";
	public static final String GSIP_SURCHARGE_EXCEL = "GSIP_Surcharge_EXCEL";


	// GSC price constants
	public static final List<String> PRICE_ATTRIBUTES = Arrays.asList(GscConstants.RATE_PER_MINUTE_FIXED,
			GscConstants.RATE_PER_MINUTE_MOBILE, GscConstants.RATE_PER_MINUTE_SPECIAL,
			...
			GscConstants.SURCHARGE_RATE, GscConstants.UIFN_REGISTRATION_CHARGE);

	//Partner GPP user Action
	public static final String GPP_USER_ACTION = "OPT_GPP_ADMIN_PARTNER";
