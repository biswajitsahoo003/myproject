...
public MacdQuoteResponse getMacdQuoteResponse() {
		...
		response.setQuoteCategory("SHIFT_SITE");
		response.setQuoteType("MACD");
	...
	public QuoteDetail getQuoteDet() {
		QuoteDetail quoteDetail = new QuoteDetail();
		/* quoteDetail.toString(); */
		quoteDetail.setCustomerId(1);
	 ...
	 * @return QuoteDetail
	 */
	public QuoteDetail getQuoteDetails() {
		QuoteDetail quoteDetail = new QuoteDetail();
		/* quoteDetail.toString(); */
		quoteDetail.setCustomerId(2);
		quoteDetail.setProductName("IZOSDWAN");
		quoteDetail.setVendorName("IZO_SDWAN_SELECT");
		quoteDetail.setQuoteleId(25026);
		quoteDetail.setQuoteId(25078);
		return quoteDetail;
	}
	...
	public QuoteToLe getQuoteToLe() {
		...
		quoteToLe.setCurrencyCode("USD");
		quoteToLe.setTermInMonths("1");
	...
	public Set<ProductSolution> getProductSolution() {
		...
		productSolution.setQuoteIzoSdwanSites(getIzoSdIzosdwanSitesList());
		...
		productSolution1.setQuoteIzoSdwanSites(getIzoSdIzosdwanSitesList());
	...
	public QuoteIzosdwanSite getIzosites1() {
	...
	public QuoteIzosdwanSite getIzosites2() {
		QuoteIzosdwanSite site = new QuoteIzosdwanSite();
		site.setId(1);
		site.setIsTaxExempted((byte) 0);
		site.setFeasibility((byte) 0);
	...
	public Set<QuoteIzosdwanSite> getIzoSdIzosdwanSitesList() {
		Set<QuoteIzosdwanSite> izoSites = new HashSet<>();
		izoSites.add(getIzosites1());
		izoSites.add(getIzosites2());
		return izoSites;
	}
	...
	public MstProductComponent getMstProductComponent11() {
		MstProductComponent component = new MstProductComponent();
		component.setDescription("ILL descriptive Value");
		component.setId(1);
	...
	public QuotePrice geQuotePrice() {
		...
		quotePrice.setEffectiveMrc(10.24D);
		/* quotePrice.toString(); */
		return quotePrice;
	}
	...
	public Set<OrderProductSolution> getOrderProductSolutionSet() {
		Set<OrderProductSolution> list = new HashSet<>();
		list.add(getOrderProductSolution());
		return list;
	}
	...
	public ProductSolution craeteproductSolutions() {
		...
		p.setProductProfileData(
				"{\"offeringName\":\"Single Internet Access\",\"solutionName\": \"Secure Web Gateway\",\"image\":\"\",\"bandwidth\":\"10\",\"bandwidthUnit\":\"mbps\",\"components\":[{\"componentId\":\"1\",\"componentMasterId\":\"1\",\"name\":\"CPE Management\",\"isActive\":\"true\",\"attributes\":[{\"attributeId\":\"1\",\"attributeMasterId\":\"1\",\"name\":\"CPE Manufacturer\",\"value\":\"CISCO\"}]}]}");

//		p.setProductProfileData("{\"solutionName\": \"Secure Web Gateway\"}");
//        p.setProductProfileData("Secure Web Gateway");
		return p;
	}
	...
	public OrderConfirmationAudit getOrderConfirmationAudit() {
		...
		orderConfirmationAudit.setOrderRefUuid("TCXVE23CV");
	...
	public CofDetails getCofDetails() {
		...
		cofDetails.setOrderUuid("TCXVE23CV");
	...
	public MacdQuoteRequest getMacdQuoteRequest() {
		...
		request.setRequestType("SHIFT_SITE");
		request.setQuoteRequest(new QuoteDetail());
		return request;
	}

	public MacdQuoteRequest getMacdQuoteRequestRequestTypeNull() {
		MacdQuoteRequest request = new MacdQuoteRequest();
	...
	public MacdQuoteRequest getMacdQuoteRequestQuoteRequestNull() {
		MacdQuoteRequest request = new MacdQuoteRequest();
		request.setRequestType("SHIFT_SITE");
		request.setQuoteRequest(null);
		return request;
	}
	...
	public MACDCancellationRequest getREquest() {
		MACDCancellationRequest request = new MACDCancellationRequest();
		request.setCancellationDate("12-12-2098");
		request.setReason("reason");
		request.setServiceId("234234DFGDF");
		return request;
	}
	...
	public SiServiceDetailBean constructSiBean() {
		SiServiceDetailBean siServiceDetailBean = new SiServiceDetailBean();
		siServiceDetailBean.setBandwidth("100");
		siServiceDetailBean.setContractEndDate(new Date());
		siServiceDetailBean.setBandwidthUnit("Mbps");
		return siServiceDetailBean;
	}

	public IzoSdwanSiteDetails constructIzosdwansiteDetails() {
		IzoSdwanSiteDetails site = new IzoSdwanSiteDetails();
		site.setSiteTypeName("Single IAS Single GVPN");
		site.setNoOfCpePorts(10);
		site.setNoOfL2Ports(8);
		site.setNoOfL3Ports(1);
		return site;
	}

	public Optional<QuoteToLe> returnQuoteToLeForUpdateStatusForContactAttributeInfo2() {
		QuoteToLe le = new QuoteToLe();
		le.setId(1);
		le.setCurrencyId(1);
		le.setErfCusCustomerLegalEntityId(1);
		...
		le.setTpsSfdcOptyId("tpsSfdcOptyId");
		le.setQuote(getQuote1());
		le.setQuoteLeAttributeValues(getQuoteLeAttributeValueSet2());
		return Optional.of(le);
	}

	public Optional<QuoteToLe> returnQuoteToLeForUpdateStatusForContactAttributeInfo3() {
		QuoteToLe le = new QuoteToLe();
		le.setId(1);
		le.setCurrencyId(1);
		le.setErfCusCustomerLegalEntityId(1);
		...
		le.setTpsSfdcOptyId("tpsSfdcOptyId");
		le.setQuote(getQuote1());
		le.setQuoteLeAttributeValues(getQuoteLeAttributeValueSet3());
		return Optional.of(le);
	}

	public Set<QuoteLeAttributeValue> getQuoteLeAttributeValueSet2() {
		Set<QuoteLeAttributeValue> quoteLeAttributeValueSet = new HashSet<>();
		QuoteLeAttributeValue quoteLeAttributeValue = getQuoteLeAttributeValue();
		quoteLeAttributeValue.getMstOmsAttribute().setName("is_feasiblity_check_done");
		quoteLeAttributeValue.setAttributeValue("1");
		quoteLeAttributeValueSet.add(quoteLeAttributeValue);
		return quoteLeAttributeValueSet;
	}
	public Set<QuoteLeAttributeValue> getQuoteLeAttributeValueSet3() {
		Set<QuoteLeAttributeValue> quoteLeAttributeValueSet = new HashSet<>();
		QuoteLeAttributeValue quoteLeAttributeValue = getQuoteLeAttributeValue();
		quoteLeAttributeValue.getMstOmsAttribute().setName("is_pricing_check_done");
		quoteLeAttributeValue.setAttributeValue("1");
		quoteLeAttributeValueSet.add(quoteLeAttributeValue);
		return quoteLeAttributeValueSet;
	}

	public List<QuoteProductComponent> getQuoteProductComponentVpn() {
		QuoteProductComponent quoteProductComponent = new QuoteProductComponent();
		quoteProductComponent.setId(1);
		quoteProductComponent.setReferenceId(1);
		quoteProductComponent.setMstProductComponent(getMstProductComponentVpn());
		quoteProductComponents.add(quoteProductComponent);
		quoteProductComponent.setMstProductFamily(geProductFamily());
		/* quoteProductComponent.toString(); */
		quoteProductComponent.setQuoteProductComponentsAttributeValues(getQuoteComponentsAttributeValues());
	...
	public MstProductComponent getMstProductComponentVpn() {
		MstProductComponent component = new MstProductComponent();
		component.setDescription("Last mile");
		component.setId(1);
	...
	public List<OrderIllSiteToService> getOrderIllSiteToServiceList(){
		...
		orderIllSiteToService.setErfServiceInventoryTpsServiceId("091CHEN030014848338");
		return orderIllSiteToServices;
	}


	public List<QuoteProductComponent> getQuoteProductComponentCgp() {
		QuoteProductComponent quoteProductComponent = new QuoteProductComponent();
		quoteProductComponent.setId(1);
		quoteProductComponent.setReferenceId(1);
		quoteProductComponent.setMstProductComponent(getMstProductComponentCgp());
		quoteProductComponents.add(quoteProductComponent);
		quoteProductComponent.setMstProductFamily(geProductFamily());
		/* quoteProductComponent.toString(); */
		quoteProductComponent.setQuoteProductComponentsAttributeValues(getQuoteComponentsAttributeValues());
	...
	public MstProductComponent getMstProductComponentCgp() {
		MstProductComponent component = new MstProductComponent();
		component.setDescription("Last mile");
		component.setId(1);
		component.setName("Cloud Gateway Port");
		component.toString();
		return component;
	}
