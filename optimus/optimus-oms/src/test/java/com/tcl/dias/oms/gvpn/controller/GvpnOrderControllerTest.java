...
/**
 * 
 * This file contains the IllOrderControllerTest.java class.
 * 
 *
...
public class GvpnOrderControllerTest {
	...
	public void init() throws TclCommonException {
		...
		when(orderProductComponentRepository.findByReferenceIdAndMstProductComponent_NameAndReferenceName(Mockito.any(), Mockito.any(),Mockito.any()))
				.thenReturn(objectCreator.getOrderProductComponentList());
	...
	public void testgetOrderDetails() throws TclCommonException {
		...
		ResponseResource<OrdersBean> response = gvpnOrderController.getOrderDetails(1);
	...
	public void testgetOrderDetailsForNull() throws TclCommonException {
		ResponseResource<OrdersBean> response = gvpnOrderController.getOrderDetails(null);
	...
	public void testeditOrderSitesForNull() throws TclCommonException {
		Mockito.when(orderProductComponentsAttributeValueRepository.findById(Mockito.anyInt()))
				.thenReturn(Optional.of(objectCreator.createOrderProducts()));
		ResponseResource<QuoteDetail> response = gvpnOrderController.editOrderSites(null, null, null, null);
		assertTrue(response.getData() == null);
	}
	...
	public void testEditOrderSitesWithoutComponentDetails() throws TclCommonException {
		...
		ResponseResource<QuoteDetail> response = gvpnOrderController.editOrderSites(null, null,
	...
	public void testEditOrderSitesWithInvalidAttributeId() throws TclCommonException {
		...
		ResponseResource<QuoteDetail> response = gvpnOrderController.editOrderSites(1, 1,
	...
	public void testeditOrderSites() throws TclCommonException {
		...
		ResponseResource<QuoteDetail> response = gvpnOrderController.editOrderSites(null, null, updateRequest, null);
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testupdateOrderSites() throws TclCommonException {
		...
		updateRequest.setSiteId(1);
		updateRequest.setQuoteId(1);
		ResponseResource<QuoteDetail> response = gvpnOrderController.updateOrderSites(null, null, updateRequest);
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testgetOrderSitesForNull() throws TclCommonException {
		ResponseResource<QuoteDetail> response = gvpnOrderController.updateOrderSites(null, null, null);
		assertTrue(response.getData() == null);
	}
	...
	public void testgetSiteDetails() throws TclCommonException {
		...
		ResponseResource<OrderIllSiteBean> response = gvpnOrderController.getSiteDetails(1, 1, 1);
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testgetSiteDetailsForNull() throws TclCommonException {
		ResponseResource<OrderIllSiteBean> response = gvpnOrderController.getSiteDetails(null, null, null);
		assertTrue(response.getData() == null);
	}
	...
	public void testgetAttachments() throws TclCommonException {
		...
		ResponseResource<List<OmsAttachBean>> response = gvpnOrderController.getAttachments(1, 1);
	...
	public void testgetAttachmentsForNull() throws TclCommonException {
		...
		Mockito.when(omsAttachmentRepository.findByOrderToLe(Mockito.any()))
				.thenReturn(objectCreator.getAttachmentsList());
		ResponseResource<List<OmsAttachBean>> response = gvpnOrderController.getAttachments(null, null);
	...
	public void testgetAttachmentsUnsatisfiedAttachementInfo() throws TclCommonException {
		...
		ResponseResource<List<OmsAttachBean>> response = gvpnOrderController.getAttachments(1, null);
		assertTrue(response.getData() == null || response.getData().isEmpty());
	}
	...
	public void testUpdateLegalEntityProperties() throws TclCommonException {
		...
		when(SecurityContextHolder.getContext().getAuthentication().getPrincipal())
				.thenReturn(objectCreator.getUserInformation());
		ResponseResource<QuoteDetail> response = gvpnOrderController.updateLeaglEntityAttribute(null, null,
	...
	public void testUpdateLegalEntityPropertiesWithOutRequest() throws TclCommonException {
		ResponseResource<QuoteDetail> response = gvpnOrderController.updateLeaglEntityAttribute(null, null, null);
		assertTrue(response.getData() == null || response.getStatus() == Status.FAILURE);
	...
	public void testUpdateQuotePositive() throws TclCommonException {
		...
		// gvpnOrderService.updateQuoteToLeStatus(1, "SOLUTIONS_CHOOSED");
		// assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	...
	public void testUpdateQuoteIdNull() throws TclCommonException {
		...
		Mockito.when(quoteToLeRepository.save(le.get())).thenReturn(le.get());
		// ResponseResource<QuoteDetail> response =
		// GvpnOrderService.updateQuoteToLeStatus(null, "ORDER_CREATED");
		// assertTrue(response != null && response.getStatus() == Status.FAILURE);
	...
	public void testUpdateOrderPositive() throws TclCommonException {
		...
		ResponseResource<QuoteDetail> response = gvpnOrderController.updateOrderToLeStatus(1, 1, "ORDER_CREATED");
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	...
	public void testUpdateOrderOrderIdNull() throws TclCommonException {
		...
		Mockito.when(orderToLeRepository.findById(Mockito.anyInt())).thenReturn(le);
		Mockito.when(orderToLeRepository.save(le.get())).thenReturn(le.get());
		ResponseResource<QuoteDetail> response = gvpnOrderController.updateOrderToLeStatus(null, null, "ORDER_CREATED");
		assertTrue(response != null && response.getStatus() == Status.FAILURE);
	...
	public void testUpdateOrderStatusNull() throws TclCommonException {
		...
		Mockito.when(orderToLeRepository.findById(Mockito.anyInt())).thenReturn(le);
		Mockito.when(orderToLeRepository.save(le.get())).thenReturn(le.get());
		ResponseResource<QuoteDetail> response = gvpnOrderController.updateOrderToLeStatus(1, null, null);
		assertTrue(response != null && response.getStatus() == Status.FAILURE);
	...
	public void testUpdateOrderNullInputs() throws TclCommonException {
		...
		Mockito.when(orderToLeRepository.findById(Mockito.anyInt())).thenReturn(le);
		Mockito.when(orderToLeRepository.save(le.get())).thenReturn(le.get());
		ResponseResource<QuoteDetail> response = gvpnOrderController.updateOrderToLeStatus(null, null, null);
		assertTrue(response != null && response.getStatus() == Status.FAILURE);
	...
	public void testUpdateOrderInvalidStatus() throws TclCommonException {
		...
		Mockito.when(orderToLeRepository.findById(Mockito.anyInt())).thenReturn(le);
		Mockito.when(orderToLeRepository.save(le.get())).thenReturn(le.get());
		ResponseResource<QuoteDetail> response = gvpnOrderController.updateOrderToLeStatus(1, null, "Test");
		assertTrue(response != null && response.getStatus() == Status.FAILURE);
	...
	public void testUpdateOrderInvalidId() throws TclCommonException {
		...
		Mockito.when(orderToLeRepository.save(le.get())).thenReturn(le.get());
		ResponseResource<QuoteDetail> response = gvpnOrderController.updateOrderToLeStatus(1, null, "ORDER_CREATED");
		// ResponseResource<QuoteDetail> response =
	...
	public void testUpdateQuoteDetail() throws TclCommonException {
		...
		ResponseResource<List<OrderSiteProvisionAudit>> response = gvpnOrderController.updateOrderSiteStatus(1, 1, 1,
	...
	public void testUpdateQuoteDetailIdNull() throws TclCommonException {
		...
		ResponseResource<List<OrderSiteProvisionAudit>> response = gvpnOrderController.updateOrderSiteStatus(null, null,
				null, request);
		assertTrue(response != null && response.getStatus() == Status.FAILURE);
	...
	public void testUpdateQuoteDetailStatusNull() throws TclCommonException {
		...
		Mockito.when(orderIllSitesRepository.findById(Mockito.anyInt()))
				.thenReturn(objectCreator.returnQuoteDetailForUpdateStatus());
		Mockito.when(orderIllSitesRepository.save(le.get())).thenReturn(le.get());
		ResponseResource<List<OrderSiteProvisionAudit>> response = gvpnOrderController.updateOrderSiteStatus(1, null,
				null, null);
		assertTrue(response != null && response.getStatus() == Status.FAILURE);
	...
	public void testGetAttributesAndSites() throws TclCommonException {
		...
		ResponseResource<OrderToLeDto> response = gvpnOrderController.getAttributesAndSites(1, 1, null);
		assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testGetAttributesAndSitesForNull() throws Exception {
		Mockito.when(orderToLeRepository.findById(Mockito.anyInt()))
				.thenReturn(Optional.of(objectCreator.getOrderToLes1()));
		ResponseResource<OrderToLeDto> response = gvpnOrderController.getAttributesAndSites(null, null, null);
	...
	public void testGetAttributesAndSitesWithAttribute() throws TclCommonException {
		Mockito.when(mstOmsAttributeRepository.findByNameAndIsActive(Mockito.anyString(), Mockito.anyByte()))
				.thenReturn(objectCreator.getMstAttributeList());
		when(orderRepository.findById(Mockito.anyInt())).thenReturn(Optional.of(objectCreator.getOrder()));
		ResponseResource<OrderToLeDto> response = gvpnOrderController.getAttributesAndSites(1, 1, "test");
		assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testGetAttributesAndSitesWithAttributeWithoutData() throws TclCommonException {
		Mockito.when(mstOmsAttributeRepository.findByNameAndIsActive(Mockito.anyString(), Mockito.anyByte()))
				.thenReturn(null);
		ResponseResource<OrderToLeDto> response = gvpnOrderController.getAttributesAndSites(1, null,
	...
	public void testGetAttributesAndSitesWithoutData() throws TclCommonException {
		Mockito.when(orderToLeRepository.findById(Mockito.anyInt())).thenReturn(Optional.empty());
		ResponseResource<OrderToLeDto> response = gvpnOrderController.getAttributesAndSites(1, null, null);
	...
	public void testGetAllOrdersByProductName() throws TclCommonException {
		...
		ResponseResource<List<DashboardOrdersBean>> response = gvpnOrderController.getAllOrdersByProductName("test");
		assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testGetAllOrdersByProductNameException() throws TclCommonException {
		ResponseResource<List<DashboardOrdersBean>> response = gvpnOrderController.getAllOrdersByProductName(null);
		assertTrue(response.getData() == null && response.getStatus() == Status.FAILURE
	...
	public void testUpdateSiteProperties() throws TclCommonException {
		...
		when(orderProductComponentsAttributeValueRepository
				.findByOrderProductComponentAndProductAttributeMaster(Mockito.any(), Mockito.any()))
						.thenReturn(objectCreator.createOrderProductsList());
		ResponseResource<OrderIllSiteBean> response = gvpnOrderController.updateSiteProperties(1, 1, 1,
				objectCreator.getUpdateRequest());
		assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS
	...
	public void testUpdateSdfcStageAsCOFReceived() throws TclCommonException {
		...
		ResponseResource<String> response = gvpnOrderController.updateSdfcStage(1, 1, "Closed Won – COF Received");
	...
	public void testUpdateSdfcStageAsOrderProcessing() throws TclCommonException {
		when(orderToLeRepository.findById(Mockito.anyInt())).thenReturn(objectCreator.returnOrderToLeForUpdateStatus());
		Mockito.doNothing().when(mqutils).send(Mockito.anyString(), Mockito.anyString());
		ResponseResource<String> response = gvpnOrderController.updateSdfcStage(1, 1, "Closed Won – Order Processing");
		assertTrue(response.getStatus() == Status.SUCCESS && response.getResponseCode() == 200);
	}
	...
	public void testGetSiteProperties() throws TclCommonException {
		...
		Mockito.when(orderProductComponentsAttributeValueRepository
				.findByOrderProductComponentAndProductAttributeMaster_Name(Mockito.any(), Mockito.anyString()))
				.thenReturn(objectCreator.createOrderProductsList());
		ResponseResource<List<OrderProductComponentBean>> response = gvpnOrderController.getSiteProperties(1, 1, 1,
				"Test Attribute");
		assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testGetOrderSiteAuditTrail() throws TclCommonException {
		Mockito.when(orderIllSitesRepository.findById(Mockito.anyInt()))
				.thenReturn(objectCreator.getOrderIllSiteOptional());
		Mockito.when(orderSiteStatusAuditRepository.findByOrderIllSiteAndIsActive(Mockito.any(), Mockito.anyByte()))
				.thenReturn(objectCreator.getOrderSiteStatusAuditList());
		ResponseResource<AuditBean> response = gvpnOrderController.getOrderSiteAuditTrail(1, 1, 1);
		assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testGetOrderSiteAuditTrailForNullSiteId() throws TclCommonException {
		...
		ResponseResource<AuditBean> response = gvpnOrderController.getOrderSiteAuditTrail(1, 1, null);
		assertTrue(response.getData() == null && response.getStatus() == Status.FAILURE);
	}

	/**
	 * test create ACCESS TOPOLOTY update hub
	 **/
	@Test
	public void testeditOrderSitesAccessTopologyHub() throws TclCommonException {
		when(orderRepository.findById(Mockito.anyInt())).thenReturn(Optional.of(objectCreator.getOrderGvpn()));
		UpdateRequest updateRequest = new UpdateRequest();
		ComponentDetail componentDetails = new ComponentDetail();
		AttributeDetail attributeDetail = new AttributeDetail();
		List<AttributeDetail> attributeDetailList = new ArrayList<>();
		...
		attributeDetail.setAttributeId(1);
		attributeDetail.setAttributeMasterId(1);
		attributeDetail.setName(AccessTopologyConstants.VPN_TOPOLOGY);
		attributeDetail.setValue(AccessTopologyConstants.HUB_SPOKE);

		AttributeDetail attributeDetailSiteType = new AttributeDetail();
		attributeDetailSiteType.setAttributeId(1);
		attributeDetailSiteType.setAttributeMasterId(1);
		attributeDetailSiteType.setName(AccessTopologyConstants.SITE_TYPE);
		attributeDetailSiteType.setValue(AccessTopologyConstants.HUB);

		attributeDetailList.add(attributeDetail);
		attributeDetailList.add(attributeDetailSiteType);

		componentDetails.setAttributes(attributeDetailList);
		componentDetails.setComponentId(1);
		componentDetails.setName(GvpnConstants.GVPN_COMMON);
		componentDetails.setComponentMasterId(1);
		componentDetailsList.add(componentDetails);
		updateRequest.setSiteId(1);
		updateRequest.setOrderId(1);
		updateRequest.setQuoteId(1);
		updateRequest.setComponentDetails(componentDetailsList);
		updateRequest.setRequestorDate(new Timestamp(new Date().getTime()));
		ResponseResource<QuoteDetail> response = gvpnOrderController.editOrderSites(null, null, updateRequest, null);
	...
	/**
	 * test create ACCESS TOPOLOTY update spoke
	 **/
	@Test
	public void testeditOrderSitesAccessTopologySpoke() throws TclCommonException {
		when(orderRepository.findById(Mockito.anyInt())).thenReturn(Optional.of(objectCreator.getOrderGvpn()));
		UpdateRequest updateRequest = new UpdateRequest();
		ComponentDetail componentDetails = new ComponentDetail();
		AttributeDetail attributeDetail = new AttributeDetail();
		...
		attributeDetailSiteType.setAttributeMasterId(1);
		attributeDetailSiteType.setName(AccessTopologyConstants.SITE_TYPE);
		attributeDetailSiteType.setValue(AccessTopologyConstants.SPOKE);
	...
	/**
	 * test create ACCESS TOPOLOTY update full mesh
	 **/
	@Test
	public void testeditOrderSitesAccessTopologySpokeFullMes() throws TclCommonException {
		when(orderRepository.findById(Mockito.anyInt())).thenReturn(Optional.of(objectCreator.getOrderGvpn()));
		UpdateRequest updateRequest = new UpdateRequest();
		ComponentDetail componentDetails = new ComponentDetail();
		AttributeDetail attributeDetail = new AttributeDetail();
		...
		attributeDetail.setAttributeMasterId(1);
		attributeDetail.setName(AccessTopologyConstants.VPN_TOPOLOGY);
		attributeDetail.setValue(AccessTopologyConstants.FULL_MESH);
