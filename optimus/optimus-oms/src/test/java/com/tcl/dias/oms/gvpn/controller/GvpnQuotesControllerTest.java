...
public class GvpnQuotesControllerTest {
	...
	public void testcreateDocument() throws TclCommonException {
		...
		ResponseResource<CreateDocumentDto> response = gvpnQuotesController.createDocument(1, 1,
	...
	public void testcreateDocumentException() throws TclCommonException {
		...
		ResponseResource<CreateDocumentDto> response = gvpnQuotesController.createDocument(null, null, null);
	...
	public void testcreateQuote() throws Exception {
		ResponseResource<QuoteResponse> response = gvpnQuotesController.createQuote(quoteObjectCreator.getQuoteDetail(),
				1,false);
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testcreateQuote2() throws Exception {
		Mockito.when(mqUtils.sendAndReceive(Mockito.anyString(), Mockito.anyString()))
				.thenReturn(quoteObjectCreator.getCustomerDetailsBean());
		ResponseResource<QuoteResponse> response = gvpnQuotesController
				.createQuote(quoteObjectCreator.getQuoteDetail2(), 1,false);
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testcreateQuoteWithDifferentOfferingName() throws Exception {
		...
		ResponseResource<QuoteResponse> response = gvpnQuotesController
				.createQuote(quoteObjectCreator.getQuoteDetailNew(), 1,false);
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testcreateQuoteExcpetion() throws Exception {
		...
		ResponseResource<QuoteResponse> response = gvpnQuotesController.createQuote(null, null,false);
		assertTrue(response.getStatus() == Status.FAILURE);
	}
	...
	public void testupdateSiteInformation() throws Exception {
		...
		ResponseResource<QuoteBean> response = gvpnQuotesController.updateSiteInformation(0, null,
	...
	public void testupdateSiteInformationException() throws Exception {
		Mockito.when(userRepository.findByUsernameAndStatus(null, 1)).thenReturn((null));
		ResponseResource<QuoteBean> response = gvpnQuotesController.updateSiteInformation(null, null, null, null);
		assertTrue(response.getStatus() == Status.FAILURE);
	}
	...
	public void testgetQuoteConfigurationException() throws Exception {
		Mockito.when(userRepository.findByUsernameAndStatus(null, 1)).thenReturn((null));
		ResponseResource<QuoteBean> response = gvpnQuotesController.getQuoteConfiguration(null, "ALL",false);
		assertTrue(response.getStatus() == Status.FAILURE);
	}
	...
	public void testgetQuoteConfiguration() throws Exception {
		...
		ResponseResource<QuoteBean> response = gvpnQuotesController.getQuoteConfiguration(1, "ALL",false);
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	...
	public void testgetAllUsersByCustomerId() throws TclCommonException {
		ResponseResource<List<UserDto>> response = gvpnQuotesController.getAllUserDetailsByCustomer();
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testgetAllUsersByCustomerIdNull() throws TclCommonException {
		Mockito.when(userRepository.findByUsernameAndStatus("admin", 1)).thenReturn(null);
		ResponseResource<List<UserDto>> response = gvpnQuotesController.getAllUserDetailsByCustomer();
		assertTrue(response.getStatus() == Status.FAILURE);
	}
	...
	public void getTaxExemptedSiteInfo() throws Exception {
		...
		ResponseResource<QuoteResponse> response = gvpnQuotesController.getTaxExemptedSiteInfo(0, null, null);
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void getTaxExemptedSiteInfoException() throws Exception {
		...
		ResponseResource<QuoteResponse> response = gvpnQuotesController.getTaxExemptedSiteInfo(null, null, null);
		assertTrue(response.getStatus() == Status.FAILURE);
	}
	...
	public void testgetSiteInfo() throws Exception {
		Mockito.when(illSiteRepository.findById(Mockito.anyInt()))
				.thenReturn(Optional.ofNullable(quoteObjectCreator.getIllsites()));
		ResponseResource<QuoteResponse> response = gvpnQuotesController.getSiteInfo(1, 1, 1);
	...
	public void testgetSiteInfoException() throws Exception {
		...
		ResponseResource<QuoteResponse> response = gvpnQuotesController.getSiteInfo(null, null, null);
		assertTrue(response.getStatus() == Status.FAILURE);
	}
	...
	public void testdeleteIllsites() throws Exception {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.deactivateSites(1, 1, 1, 1,
	...
	public void testdeleteIllsitesException() throws Exception {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.deactivateSites(null, null, null, null, null);
		assertTrue(response.getStatus() == Status.FAILURE);
	}
	...
	public void testTriggerEmail() throws TclCommonException {
		...
		ResponseResource<TriggerEmailResponse> response = gvpnQuotesController.triggerEmail(null, null, triggerRequest,
				httpServletRequest);
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testgetDelegatedUsers() throws TclCommonException {
		...
		ResponseResource<QuoteDelegationDto> response = gvpnQuotesController.getDelegatedUser();
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testdisableIllsites() throws Exception {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.deactivateSites(1, 2, 5, 1,
	...
	public void testdisableIllsitesNegativeCase() throws Exception {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.deactivateSites(0, 0, 0, null, "");
		assertTrue(response.getStatus() == Status.FAILURE);
	}
	...
	public void testQuotesDetailsBasedOnCustomer() throws Exception {
		...
		ResponseResource<List<QuoteBean>> response = gvpnQuotesController.getQuotesDetailsBasedOnCustomer(1);
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testgetQuotesDetailsBasedOnCustomerLegalEntity() throws Exception {
		...
		ResponseResource<List<QuoteBean>> response = gvpnQuotesController.getQuotesDetailsBasedOnCustomerLegalEntity(1);
		assertTrue(response != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testeditSites() throws Exception {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.editSites(null, null, null,
	...
	public void testeditSitesUpdateCpe() throws Exception {
		Mockito.when(illSiteRepository.findById(Mockito.any())).thenReturn((Optional.of(quoteObjectCreator.getQuoteIllSite())));
		ResponseResource<QuoteDetail> response = gvpnQuotesController.editSites(null, null, null,
	...
	public void testeditSitesNegativeCase() throws Exception {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.editSites(null, null, null, null);
		assertTrue(response.getStatus() == Status.FAILURE);
	}
	...
	public void testDashboardNegativeCase() throws Exception {
		...
		ResponseResource<DashBoardBean> response = gvpnQuotesController.getDashboardDetails(null);
	...
	public void testDashboard() throws Exception {
		...
		when(SecurityContextHolder.getContext().getAuthentication().getPrincipal())
				.thenReturn(quoteObjectCreator.getUserInformation());
		ResponseResource<DashBoardBean> response = gvpnQuotesController.getDashboardDetails(1);
	...
	public void testApprovedQuotes() throws TclCommonException {
		...
		MockHttpServletRequest httpServletRequest = new MockHttpServletRequest();
		httpServletRequest.setParameter("X-Forwarded-For", "127.0.0.1");
		ResponseResource<QuoteDetail> response = gvpnQuotesController
				.approvedQuotes(quoteObjectCreator.getUpdateRequest(), httpServletRequest);
	...
	public void testApprovedQuotesNegativeCase() throws TclCommonException {
		...
		MockHttpServletRequest httpServletRequest = new MockHttpServletRequest();
		httpServletRequest.setParameter("X-Forwarded-For", "127.0.0.1");
		ResponseResource<QuoteDetail> response = gvpnQuotesController.approvedQuotes(null, httpServletRequest);
		assertTrue(response.getStatus() == Status.FAILURE);
	}
	...
	public void testGetQuotesDetailsBasedOnCustomeAsCustomerIdAsNull() throws TclCommonException {
		...
		ResponseResource<List<QuoteBean>> response = gvpnQuotesController.getQuotesDetailsBasedOnCustomer(null);
	...
	public void testGetQuotesDetailsBasedOnCustomerLegalEntityAsIdNull() throws TclCommonException {
		...
		ResponseResource<List<QuoteBean>> response = gvpnQuotesController
				.getQuotesDetailsBasedOnCustomerLegalEntity(null);
	...
	public void testupdateSiteProperties() throws TclCommonException {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.updateSiteProperties(null, null, null,
				quoteObjectCreator.getUpdateRequest());
		assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testupdateSitePropertiesForException() throws TclCommonException {
		...
		Mockito.when(quoteProductComponentsAttributeValueRepository.save(Mockito.any()))
				.thenReturn(quoteObjectCreator.getAttribute());
		ResponseResource<QuoteDetail> response = gvpnQuotesController.updateSiteProperties(null, null, null, null);
		assertTrue(response.getData() == null && response.getStatus() == Status.FAILURE);
	}
	...
	public void testupdateSitePropertiesForInvaliedRequest() throws TclCommonException {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.updateSiteProperties(null, null, null, request);
		assertTrue(response.getData() == null && response.getStatus() == Status.FAILURE);
	}
	...
	public void testupdateLegalEntityProperties() throws TclCommonException {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.updateLegalEntityProperties(1, 1,
				quoteObjectCreator.getUpdateRequest());
		assertTrue(response != null);

		QuoteDetail details = gvpnQuoteService.updateLegalEntityProperties(quoteObjectCreator.getUpdateRequest());
	...
	public void testupdateLegalEntityPropertiesForException() throws TclCommonException {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.updateLegalEntityProperties(null, null, null);
		assertTrue(response.getData() == null && response.getStatus() == Status.FAILURE);
	}
	...
	public void testupdateLegalEntityPropertiesForQuote() throws TclCommonException {
		...
		UpdateRequest request = quoteObjectCreator.getUpdateRequest();
		ResponseResource<QuoteDetail> response = gvpnQuotesController.updateLegalEntityProperties(null, null, request);
		assertTrue(response.getData() == null && response.getStatus() == Status.FAILURE);
	}
	...
	public void testgetSiteProperties() throws TclCommonException {
		ResponseResource<List<QuoteProductComponentBean>> response = gvpnQuotesController.getSiteProperties(0, 1, 1);
		assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testgetSitePropertiesForException() throws TclCommonException {
		ResponseResource<List<QuoteProductComponentBean>> response = gvpnQuotesController.getSiteProperties(null, null,
				null);
		assertTrue(response.getResponseCode() == 500 || response.getData().isEmpty() || response == null);
	}
	...
	public void testgetSitePropertiesExceptionForEmptySiteProperties() throws TclCommonException {
		...
		ResponseResource<List<QuoteProductComponentBean>> response = gvpnQuotesController.getSiteProperties(0, null,
				null);
		assertTrue(response.getResponseCode() == 500 || response.getData().isEmpty() || response == null);
	}
	...
	public void getAttributeDetailsByQuoteToLeId() throws TclCommonException {
		ResponseResource<Set<LegalAttributeBean>> response = gvpnQuotesController.getAllAttributesByQuoteToLeId(1, 1);
		assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void getAttributeDetailsByQuoteToLeIdWithoutID() throws TclCommonException {
		ResponseResource<Set<LegalAttributeBean>> response = gvpnQuotesController.getAllAttributesByQuoteToLeId(null,
				null);
		assertTrue(response != null && response.getStatus() == Status.FAILURE);
	}
	...
	public void getAttributeDetailsByQuoteToLeIdWithoutData() throws TclCommonException {
		Mockito.when(quoteToLeRepository.findById(Mockito.anyInt())).thenReturn(Optional.empty());
		ResponseResource<Set<LegalAttributeBean>> response = gvpnQuotesController
				.getAllAttributesByQuoteToLeId((Integer) 1, 1);
		assertTrue(response != null && response.getStatus() == Status.FAILURE);
	}
	...
	public void testUpdateQuoteToLeStatus() throws TclCommonException {
		...
		QuoteDetail response = gvpnQuoteService.updateQuoteToLeStatus(1, "test");
		assertTrue(response != null);
	...
	public void testUpdateQuoteToLeStatusforNullquoteToLeIdstatus() throws TclCommonException {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.updateQuoteToLeStatus(null, null, null);
		assertTrue(response.getData() == null && response.getStatus() == Status.FAILURE);
	}
	...
	public void testUpdateQuoteToLeStatusforEmptyQuoteToLe() throws TclCommonException {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.updateQuoteToLeStatus(1, 1, "Test");
		assertTrue(response.getData() == null && response.getStatus() == Status.FAILURE);
	}
	...
	public void testUpdateQuoteToLeStatusforQuoteToLe() throws TclCommonException {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.updateQuoteToLeStatus(1, 1, "SELECT_CONFIGURATION");
		assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
	}
	/*
	...
	public void testPersistListOfQuoteLeAttributes() throws TclCommonException {
		...
		ResponseResource<QuoteDetail> response = gvpnQuotesController.persistListOfQuoteLeAttributes(1, 1,
				quoteObjectCreator.getUpdateRequest());
		assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
	}
	...
	public void testtriggerForFeasibilityBean() throws Exception {
		...
		Mockito.when(mqUtils.sendAndReceive(Mockito.anyString(), Mockito.eq("1")))
				.thenReturn(quoteObjectCreator.getCustomerDetailsBean());
		ResponseResource<String> response = gvpnQuotesController
	...
	public void testGetContactAttributeDetails() throws TclCommonException {
		...
		nameValue.forEach(value -> {
			...
			try {
				ResponseResource<ContactAttributeInfo> response = gvpnQuotesController.getContactAttributeDetails(1, 1);
				assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
	...
	public void testUpdateSdfcStage() throws TclCommonException {
		Mockito.when(quoteToLeRepository.findById(Mockito.anyInt()))
				.thenReturn(quoteObjectCreator.returnQuoteToLeForUpdateStatus());
		ResponseResource<String> response = gvpnQuotesController.updateSdfcStage(1, 1, "Proposal Sent");
		assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
	...
	public void testUpdateBillingInfoForSfdc() throws TclCommonException {
		...
		ResponseResource<QuoteBean> response = gvpnQuotesController
	...
	public void testpricing() throws TclCommonException {
		...
		ResponseResource<String> response = gvpnQuotesController.triggerPricing(1, 1);
		assertTrue(response.getData() != null && response.getStatus() != Status.FAILURE);
	}
	...
	public void testpricingWithNull() throws TclCommonException {
		...
		ResponseResource<String> response = gvpnQuotesController.triggerPricing(null, null);
		assertTrue(response == null);
	}
	...
	public void testFeasibilityCheck() throws TclCommonException {
		...
		nameValue.forEach(value -> {
			...
			Mockito.when(quoteToLeRepository.findById(Mockito.anyInt())).thenReturn(quToLe);
			try {
				ResponseResource<QuoteLeAttributeBean> response = gvpnQuotesController.feasibilityCheck(1);
				assertTrue(response.getData() != null && response.getStatus() == Status.SUCCESS);
			} catch (TclCommonException e) {
				e.printStackTrace();
			}
	...
	public void testUpdateSitePropertiesAttributes() throws Throwable {
		...
		QuoteDetail response = gvpnQuoteService.updateSitePropertiesAttributes(quoteObjectCreator.getUpdateRequest());
		assertTrue(response != null);
	...
	public void testUpdateSitePropertiesAttributesForNullQuoteProductComponentsAttributeValue()
		...
		QuoteDetail response = gvpnQuoteService.updateSitePropertiesAttributes(quoteObjectCreator.getUpdateRequest());
		assertTrue(response != null);
		ResponseResource<QuoteDetail> res = gvpnQuotesController.updateSitePropertiesAttributes(1, 1, 1,
				quoteObjectCreator.getUpdateRequest());
	...
	public void testUpdateSitePropertiesAttributesForNullQuoteProductComponent() throws TclCommonException {
		...
		QuoteDetail response = gvpnQuoteService.updateSitePropertiesAttributes(quoteObjectCreator.getUpdateRequest());
		assertTrue(response != null);
		QuoteDetail res1 = gvpnQuoteService.updateSitePropertiesAttributes(quoteObjectCreator.getUpdateRequest());
	...
	public void testUpdateSitePropertiesAttributesForMstProductFamily() throws TclCommonException {
		...
		Mockito.when(mstProductFamilyRepository.findByNameAndStatus(Mockito.anyString(), Mockito.anyByte()))
				.thenReturn(null);
		ResponseResource<QuoteDetail> response = gvpnQuotesController.updateSitePropertiesAttributes(1, 1, 1,
				quoteObjectCreator.getUpdateRequest());
		assertTrue(response.getData() == null && response.getStatus() == Status.FAILURE);
	}
	...
	public void testUpdateSitePropertiesAttributesForNullUpdateRequest() throws TclCommonException {
		ResponseResource<QuoteDetail> response = gvpnQuotesController.updateSitePropertiesAttributes(1, 1, 1, null);
		assertTrue(response.getData() == null && response.getStatus() == Status.FAILURE);
	}
	...
	public void testUpdateCurrency() throws TclCommonException {
		...
		ResponseResource<String> response = gvpnQuotesController.updateCurrency(679, 678, "USD");
	...
	public void testUpdateCurrencyForNull() throws TclCommonException {
		...
		ResponseResource<String> response = gvpnQuotesController.updateCurrency(null, null, null);
		System.out.println(response.getResponseCode());
		assertTrue(response.getData() == null && response.getStatus() == Status.FAILURE);
	}
	...
	@Test
	public void getSupplierUnavailableTriggerEmail() throws TclCommonException {
		ResponseResource<TriggerEmailResponse> response = gvpnQuotesController.getSupplierUnavailableTriggerEmail(1, 1);
		assertTrue(response != null);
	}

	@Test
	public void getNegativeSupplierUnavailableTriggerEmail() throws TclCommonException {
		Mockito.when(mstOmsAttributeRepository.findByNameAndIsActive(Mockito.anyString(), Mockito.anyByte()))
				.thenReturn(quoteObjectCreator.getMstAttributeList());
		Mockito.when(quoteLeAttributeValueRepository.findByQuoteToLeAndMstOmsAttribute(Mockito.any(), Mockito.any()))
				.thenReturn(null);
		...
		ResponseResource<TriggerEmailResponse> response = gvpnQuotesController.getSupplierUnavailableTriggerEmail(null,
				null);
		assertTrue(response != null);
	}
	...
	public void generateCof() throws TclCommonException {
		...
		ResponseResource<String> generateCofPdf = gvpnQuotesController.generateCofPdf(1, 1, response, false);
	...
	public void testNegativeGenerateCof() throws TclCommonException {
		ResponseResource<String> generateCofPdf = gvpnQuotesController.generateCofPdf(1, 1, null, false);
		assertTrue(generateCofPdf != null);
	...
	public void approvedManualQuotes() throws TclCommonException {
		...
		Mockito.when(siteFeasibilityRepository.findByQuoteIllSite(Mockito.any()))
		.thenReturn(quoteObjectCreator.getSiteFeasibilities1());
		ResponseResource<QuoteDetail> resource = gvpnQuotesController.approvedManualQuotes(1, 1, response);
	...
	public void testNegativeapprovedManualQuotes() throws TclCommonException {
		ResponseResource<QuoteDetail> resource = gvpnQuotesController.approvedManualQuotes(1, 1, null);
		assertTrue(resource != null);
	...
	public void generateQuotePdf() throws TclCommonException {
		HttpServletResponse response = mock(HttpServletResponse.class);
		ResponseResource<String> generateCofPdf = gvpnQuotesController.generateQuotePdf(1, 1, response);
	...
	public void testNegativegenerateQuotePdf() throws TclCommonException {
		...
		ResponseResource<String> generateCofPdf = gvpnQuotesController.generateQuotePdf(1, 1, null);
		assertTrue(generateCofPdf != null);
	...
	public void shareQuote() throws TclCommonException {
		HttpServletResponse response = mock(HttpServletResponse.class);
		ResponseResource<ServiceResponse> responseResource = gvpnQuotesController.shareQuote(1, 1,
	...
	public void testNegativeShareQuote() throws TclCommonException {
		...
		ResponseResource<ServiceResponse> responseResource = gvpnQuotesController.shareQuote(null, null, null);
		assertTrue(responseResource != null);
	...
	public void triggerAccountManagerCofDownloadNotification() throws TclCommonException {
		HttpServletResponse response = mock(HttpServletResponse.class);
		ResponseEntity<String> responseResource = gvpnQuotesController.triggerAccountManagerCofDownloadNotification(1,
				2);
	...
	public void testNegativetriggerAccountManagerCofDownloadNotification() throws TclCommonException {
		...
		ResponseEntity<String> responseResource = gvpnQuotesController
				.triggerAccountManagerCofDownloadNotification(null, null);
		assertTrue(responseResource != null);
	...
	public void uploadCofPdf() throws TclCommonException, IOException {
		...
		ResponseResource<String> responseResource = gvpnQuotesController.uploadCofPdf(1, 2, response, result);
	...
	public void NegativeuploadCofPdf() throws TclCommonException, IOException {
		...
		MultipartFile result = new MockMultipartFile(name, originalFileName, contentType,
				quoteObjectCreator.getFileAsByteArray());
		ResponseResource<String> responseResource = gvpnQuotesController.uploadCofPdf(1, 2, response, null);
		assertTrue(responseResource != null);
	...
	public void processDocusign() throws TclCommonException, IOException {
		...
		ResponseResource<String> responseResource = gvpnQuotesController.processDocusign(1, 1, false, "v",
				"vivek@gmail.com",null, response);
	...
	public void testEmailTrigger() throws TclCommonException, IOException {
		ResponseResource<TriggerEmailResponse> responseResource = gvpnQuotesController.getCustomerEmailIdTriggerEmail(1, 1);
		assertTrue(responseResource != null);
