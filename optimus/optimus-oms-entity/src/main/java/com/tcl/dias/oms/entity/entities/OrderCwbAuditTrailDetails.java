...
/**
 * This file contains the OrderCwbAuditTrailDetails.java class.
 * 
 *
...
@Entity
@Table(name = "order_cwb_audit_trail")
public class OrderCwbAuditTrailDetails implements Serializable {
	...
	public OrderCwbAuditTrailDetails() {

	}

	
	public OrderCwbAuditTrailDetails(Integer id, Integer orderId, Integer customerId, String userName, String currency,
	...
	public String toString() {
		return "OrderCwbAuditTrailDetails [id=" + id + ", orderId=" + orderId + ", customerId=" + customerId
