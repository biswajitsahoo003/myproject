 ...
 */
@Entity
@Table(name = "link_feasibility_audit")
@NamedQuery(name = "LinkFeasibilityAudit.findAll", query = "SELECT s FROM LinkFeasibilityAudit s")
public class LinkFeasibilityAudit implements Serializable {
	...
	@JoinColumn(name = "link_feasibility_id")
	private LinkFeasibility linkFeasibility;

	public LinkFeasibilityAudit() {
		// DO NOTHING
	}
	...
	public void setLinkFeasibility(LinkFeasibility linkFeasibility) {
