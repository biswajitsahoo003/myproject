...
/**
 * This file contains the OdrTeamsDRServiceCommercial.java class.
 *
 * @author Syed Ali
 ...
 */
@Entity
@Table(name = "odr_teamsdr_service_commercial")
@NamedQuery(name = "OdrTeamsDRServiceCommercial.findAll", query = "SELECT o FROM OdrTeamsDRServiceCommercial o")
public class OdrTeamsDRServiceCommercial implements Serializable {
