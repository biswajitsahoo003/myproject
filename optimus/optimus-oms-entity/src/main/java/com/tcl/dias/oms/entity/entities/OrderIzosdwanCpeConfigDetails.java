...
/**
 * This file contains the OrderIzosdwanCpeConfigDetails.java class.
 * 
 *
...
@Entity
@Table(name = "order_izosdwan_cpe_config")
public class OrderIzosdwanCpeConfigDetails implements Serializable {
	...
	public OrderIzosdwanCpeConfigDetails() {
		super();
		// TODO Auto-generated constructor stub
	}


	public OrderIzosdwanCpeConfigDetails(Integer id, Integer orderLeId, Integer locationId, String attributeType,
	...
	public String toString() {
		return "OrderIzosdwanCpeConfigDetails [id=" + id + ", orderLeId=" + orderLeId + ", locationId=" + locationId
