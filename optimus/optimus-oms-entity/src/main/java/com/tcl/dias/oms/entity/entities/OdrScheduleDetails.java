 ...
 */
@Entity
@Table(name="odr_schedule_details")
@NamedQuery(name="OdrScheduleDetails.findAll", query="SELECT o FROM OdrScheduleDetails o")
public class OdrScheduleDetails implements Serializable {
