...
public class QuotePriceBean implements Serializable {
	...
	public QuotePriceBean(QuotePrice price) {
		if (price != null) {
			...
			this.discountArc = price.getDiscountPercentArc();
			this.discountNrc = price.getDiscountPercentNrc();
			this.discountMrc = price.getDiscountPercentMrc();
		}
	}
	...
	public Double getDiscountMrc() { return discountMrc; }

	public void setDiscountMrc(Double discountMrc) { this.discountMrc = discountMrc; }
