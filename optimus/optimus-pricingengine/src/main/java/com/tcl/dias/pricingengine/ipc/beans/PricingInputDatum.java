...
/**
 * 
 * This file contains the PricingInputDatum.java class.
 * 
 *
 * @author Manojkumar R
...
@JsonPropertyOrder({ "site_id", "latitude_final", "longitude_final", "prospect_name", "bw_mbps", "burstable_bw",
		...
		"ipv6_address_pool_size", "cu_le_id", "macd_service", "ll_change", "macd_option", "trigger_feasibility",
		"old_contract_term", "service_commissioned_date", "lat_long", "service_id", "backup_port_requested",
		"old_Port_Bw", "old_Ll_Bw", "parallel_run_days", "cpe_chassis_changed", "local_loop_bw" })
