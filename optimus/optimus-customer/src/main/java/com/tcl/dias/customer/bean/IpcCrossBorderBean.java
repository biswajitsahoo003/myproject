...
@JsonPropertyOrder({ "dcLocationId", "customerLeCountry", "crossBorderWhTaxPercentage", "isCrossBorderTaxApplicable","dcLocationCountry" })
public class IpcCrossBorderBean {
	...
	public String toString() {
		return "IpcCrossBorderBean [dcLocationId=" + dcLocationId + ", dcLocationCountry=" + dcLocationCountry
