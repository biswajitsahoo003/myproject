...
/**
 * This file contains the CustomerLeBillingInfoDto.
 * 
 * Use to send the response for edit billing details
 *
 * @author Biswajit
 * @link http://www.tatacommunications.com/
 * @copyright 2018 Tata Communications Limited
 */
public class CustomerLeBillingInfoDto {
	...
	public CustomerLeBillingInfoDto(CustomerLeBillingInfo customerLeBillingInfo) {
		if (customerLeBillingInfo != null) {
			this.billingInfoId = customerLeBillingInfo.getId();
			this.billAccNo = customerLeBillingInfo.getBillAccNo();
			this.billAddr = customerLeBillingInfo.getBillAddr();
			this.emailId = customerLeBillingInfo.getEmailId();
			this.fname = customerLeBillingInfo.getFname();
			this.lname = customerLeBillingInfo.getLname();
			this.phoneNumber = customerLeBillingInfo.getPhoneNumber();
			this.customerLeEntityId=customerLeBillingInfo.getCustomerLegalEntity().getTpsSfdcCuid();
		}
