...
@Component("mfProcessEndDelegate")
public class MfProcessEndDelegate implements PlanItemJavaDelegate {

	private static final Logger logger = LoggerFactory.getLogger(MfProcessEndDelegate.class);
	...
	public void execute(DelegatePlanItemInstance planItemInstance) {
		...
		workFlowService.initiateMfProcessCompletion(planItemInstance);
