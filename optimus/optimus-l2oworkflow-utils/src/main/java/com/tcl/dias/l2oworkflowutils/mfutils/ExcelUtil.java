...
public class ExcelUtil {
	...
	public static <T> byte[] writeXLSXFile(List<T> beanList, String feasibilityType,String sheetName, String excelFileName, String message)
		...
		if (beanList == null || beanList.isEmpty()) {
			...
			Cell cell2 = context.row.createCell(16);
			...
			Cell cell3 = context.row.createCell(22);
			sheet.addMergedRegion(new CellRangeAddress(0, 0, 22, 42));
			...
			Cell cell4 = context.row.createCell(43);
			...
			else if(feasibilityType.equals("MAN/VBL"))
			{
				...
				Cell cell2 = context.row.createCell(15);
				...
				Cell cell4 = context.row.createCell(28);
				...
				Cell cell3 = context.row.createCell(19);
				sheet.addMergedRegion(new CellRangeAddress(0, 0, 19, 39));
				cell3.setCellValue("RF Response");
				CellStyle headerCellStyle3= beautifyHeader(wb,IndexedColors.LIGHT_YELLOW.getIndex());
				cell3.setCellStyle(headerCellStyle3);
			}
