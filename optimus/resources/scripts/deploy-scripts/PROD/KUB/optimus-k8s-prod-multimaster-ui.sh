...
sudo docker tag optimus-ui:latest 10.132.12.233:32550/optimus-ui:latest
sudo docker push 10.132.12.233:32550/optimus-ui:latest
...
## Remove containers
kubectl --kubeconfig=/docker/script/workspace/prod-kubeconfig-multimaster -n optimus delete deployment optimus-ui
sleep 30

## Run Containers
kubectl --kubeconfig=/docker/script/workspace/prod-kubeconfig-multimaster -n optimus run optimus-ui --image=10.132.12.233:32550/optimus-ui:latest --port=80 --replicas=1 --env="http_proxy="$HTTP_PROXY  --env="https_proxy="$HTTPS_PROXY
