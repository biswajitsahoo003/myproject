...
sudo docker tag optimus-pdf:latest 10.132.12.233:32550/optimus-pdf:latest
sudo docker push 10.132.12.233:32550/optimus-pdf:latest
...
## Remove containers
kubectl --kubeconfig=/docker/script/workspace/prod-kubeconfig-multimaster -n optimus delete deployment optimus-pdf
sleep 30

## Run Containers
kubectl --kubeconfig=/docker/script/workspace/prod-kubeconfig-multimaster -n optimus run optimus-pdf --image=10.132.12.233:32550/optimus-pdf:latest --port=8000 --replicas=1 --env="http_proxy="$HTTP_PROXY  --env="https_proxy="$HTTPS_PROXY
