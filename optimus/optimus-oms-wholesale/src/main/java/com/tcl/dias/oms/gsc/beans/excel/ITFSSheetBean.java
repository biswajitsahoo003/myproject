 ...
 */
public class ITFSSheetBean extends OrderEnrichmentExcel {
    ...
    public ITFSSheetBean() {
    }

    public ITFSSheetBean(String originCountry, String quantityRequired, String portedStatus, String outPulseNumber, String portedNumber) {
