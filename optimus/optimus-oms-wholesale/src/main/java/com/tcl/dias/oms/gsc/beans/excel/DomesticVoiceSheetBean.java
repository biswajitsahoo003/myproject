...
public class DomesticVoiceSheetBean extends OrderEnrichmentExcel {
    ...
    public DomesticVoiceSheetBean(String originCountry, String city, String streetAddress, String suit, String state, String postalCode,
                                  String registrationNumber, String quantityRequired, String portedStatus, String portedNumber) {
