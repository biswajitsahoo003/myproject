...
@JsonPropertyOrder({"account_id_with_18_digit", "cu_le_id", "Account_RTM_Cust", "customer_segment", "sales_org",
        ...
        "lns_requested", "uifn_requested", "acs_dtf_requested", "acs_ans_requested", "acs_sns_requested", "dom_voice_requested",
        "glob_out_requested", "origin_itfs", "destination_itfs", "no_requested_itfs", "no_ported_itfs", "origin_lns",
        "destination_lns", "no_requested_lns", "no_ported_lns", "origin_uifn", "destination_uifn", "no_requested_uifn",
        "no_ported_uifn", "origin_dtfs", "destination_dtfs", "no_requested_dtfs", "origin_acns", "destination_acns",
        "no_requested_acns", "origin_acsns", "destination_acsns", "no_requested_acsns", "origin_dom_voice",
        "no_requested_dom_voice", "no_ported_dom_voice", "channels_dom_voice",
        "destination_glob_out"})
public class PricingRequest {
    ...
    public String toString() {
        return "PricingRequest{" +
                ...
                ", accountRTMCust='" + accountRTMCust + '\'' +
                ", salesOrg='" + salesOrg + '\'' +
                ", volumeProjected='" + volumeProjected + '\'' +
                ", inboundVolume='" + inboundVolume + '\'' +
                ", outboundVolume='" + outboundVolume + '\'' +
                ", inboundSelectCust=" + inboundSelectCust +
                ", outboundSelectCust=" + outboundSelectCust +
                ", quoteTypeQuote='" + quoteTypeQuote + '\'' +
                ", macdNewCountry='" + macdNewCountry + '\'' +
                ", orgId='" + orgId + '\'' +
                ", opportunityTerm='" + opportunityTerm + '\'' +
                ", accessType='" + accessType + '\'' +
                ", itfsRequested='" + itfsRequested + '\'' +
                ", lnsRequested='" + lnsRequested + '\'' +
                ", uifnRequested='" + uifnRequested + '\'' +
                ", acsDtfRequested='" + acsDtfRequested + '\'' +
                ", acsAnsRequested='" + acsAnsRequested + '\'' +
                ", domesticVoiceRequested='" + domesticVoiceRequested + '\'' +
                ", globalOutboundRequested='" + globalOutboundRequested + '\'' +
                ", originItfs=" + originItfs +
                ", destinationItfs=" + destinationItfs +
                ", noRequestedItfs=" + noRequestedItfs +
                ", noPortedItfs=" + noPortedItfs +
                ", originLns=" + originLns +
                ", destinationLns=" + destinationLns +
                ", noRequestedLns=" + noRequestedLns +
                ", noPortedLns=" + noPortedLns +
                ", originUifn=" + originUifn +
                ", destinationUifn=" + destinationUifn +
                ", noRequestedUifn=" + noRequestedUifn +
                ", noPortedUifn=" + noPortedUifn +
                ", originDtfs=" + originDtfs +
                ", destinationDtfs=" + destinationDtfs +
                ", noRequestedDtfs=" + noRequestedDtfs +
                ", originAcns=" + originAcns +
                ", destinationAcns=" + destinationAcns +
                ", noRequestedAcns=" + noRequestedAcns +
                ", originDomesticVoice=" + originDomesticVoice +
                ", noRequestedDomesticVoice=" + noRequestedDomesticVoice +
                ", noPortedDomesticVoice=" + noPortedDomesticVoice +
                ", destinationGlobalOutbound=" + destinationGlobalOutbound +
                ", channelsDomesticVoice=" + channelsDomesticVoice +
